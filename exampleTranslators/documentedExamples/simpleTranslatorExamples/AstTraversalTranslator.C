...
class MyTraversal : public SgTopDownBottomUpProcessing<MyInheritedAttribute,
...
int main(int argc, char *argv[]) {
  ...
  // Build the project object which we will fill up with multiple files and use
  // as a handle for all processing of the AST(s) associated with one or more
  // source files.
