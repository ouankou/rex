...
//    2) if the source file info for the statements are from filename
//    "configure"
// Then, this is the clue that this is a test file gnerated as part of
// configure-probe and so we want to process it as a special file so that ROSE
// can be used to within the configure-probe build system testing.  Since any
