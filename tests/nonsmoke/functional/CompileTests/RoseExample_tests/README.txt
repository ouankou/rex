...
parts of ROSE that don't appear to compile with legacy frontend and which need to
...
there may be some code that GNU accepts that legacy frontend does not accept.
