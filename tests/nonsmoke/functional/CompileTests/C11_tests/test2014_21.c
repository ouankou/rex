...
// float b[4] __attribute__((aligned(0x1000))) = { 1.0, 2.0, 3.0, 4.0 };  legacy
// frontend reports error: invalid alignment value specified by attribute float
// b[4] __attribute__((aligned(8))) = { 1.0, 2.0, 3.0, 4.0 };
