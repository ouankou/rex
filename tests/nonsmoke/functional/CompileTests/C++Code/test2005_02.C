...
// 1st overloaded function!
   ...
   /*
   Possible explanation (sent by Markus and found in vendor documentation):
   ...
   If no match is found the call is an error. In each case, if there is more
   than one alternative in the first step that finds a match, the call is
