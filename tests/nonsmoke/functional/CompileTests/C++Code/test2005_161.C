// This test code show how "string::npos" is output as a constant value instead
// of as a variable name.  In addition to this problem, the value output is the
// evaluation of "-1" cast to an "unsigned int" (size_t, which I think is
// "unsigned int").
