...
tux49.llnl.gov{dquinlan}34:
/home/dquinlan2/ROSE/LINUX-3.3.2/bin/identityTranslator foo.C This SgProject
constructor is deprecated, do not use. Finished building legacy frontend AST,
now build the SAGE AST ...
/* AST Fixes started. */
