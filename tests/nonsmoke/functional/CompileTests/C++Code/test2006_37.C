...
// instead of the scope of the firstDefiningDeclaration.
   ...
   // Note that specification of template argument as in
   // getCoreMesh<Geometry::PolyMesh> is optional but only one instantiation
   // directive is allowed template void
   // Geometry::getCoreMesh<Geometry::PolyMesh>(Geometry::MeshBase<Geometry::PolyMesh
   // >&);

   // The following is not allowed:
   // template void
   // Geometry::getCoreMesh<Geometry::PolyMesh>(Geometry::MeshBase<>&);
