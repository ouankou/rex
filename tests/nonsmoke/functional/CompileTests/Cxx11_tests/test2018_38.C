...
// DQ (1/24/2017): Added declaration of this type that comes from the
// rose_required_macros_and_functions.h file. Note that this is only required
...
#include <map>
namespace LEOS {
enum functionsType { FT_Bcv, FT_Cs, FT_Bltemp };
