...
extern int _gl_cxxalias_dummy;
// # 782 "../lib/sys/stat.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
// # 825 "../lib/sys/stat.h" 3
extern int _gl_cxxalias_dummy;
...
extern int _gl_cxxalias_dummy;
// # 920 "../lib/string.h" 3
extern char * rpl_strcasestr (const char *haystack, const char *needle) __attribute__ ((__pure__)) __attribute__ ((__nonnull__ (1, 2)));
...
// DQ (10/20/2012): This results in constant adress with offset of 104 (this original position).
  ...
  void *(*regex_compile_fun)(const char *);
  _Bool (*regex_match_fun)(const void *, const char *);
  ...
  wgint warc_maxsize;
  _Bool warc_compression_enabled;
  _Bool warc_digests_enabled;
  _Bool warc_cdx_enabled;
  _Bool warc_keep_log;
  char **warc_user_headers;
  ...
  _Bool trustservernames;




  _Bool useservertimestamps;


  _Bool show_all_dns_entries;
...
void debug_logprintf (const char *, ...) __attribute__ ((format (printf, 1, 2)));
void logputs (enum log_options, const char *);
void logflush (void);
void log_set_flush (_Bool);
_Bool log_set_save_context (_Bool);

void log_init (const char *, _Bool);
void log_close (void);
...
_Bool check_encoding_name (char *encoding);
const char *locale_to_utf8 (const char *str);
char *idn_encode (struct iri *i, char *host);
char *idn_decode (char *host);
_Bool remote_to_utf8 (struct iri *i, const char *str, const char **new);
struct iri *iri_new (void);
struct iri *iri_dup (const struct iri *);
void iri_free (struct iri *i);
void set_uri_encoding (struct iri *i, char *charset, _Bool force);
...
extern int execve (const char *__path, char *const __argv[],
     char *const __envp[]) __attribute__ ((__nothrow__)) __attribute__ ((__nonnull__ (1)));
...
extern int _gl_cxxalias_dummy;
// # 1442 "../lib/unistd.h" 3
extern int pipe2 (int fd[2], int flags) __attribute__ ((__nonnull__ (1)));
extern int _gl_cxxalias_dummy;
...
// # 88 "/usr/include/pcre.h" 3 4
// # 1 "../lib/stdlib.h" 1 3 4
// # 20 "../lib/stdlib.h" 3 4
       
// # 21 "../lib/stdlib.h" 3
// # 89 "/usr/include/pcre.h" 2 3 4
...
_Bool subdir_p (const char *, const char *);
void fork_to_background (void);

char *aprintf (const char *, ...) __attribute__ ((format (printf, 1, 2)));
char *concat_strings (const char *, ...);

void touch (const char *, time_t);
int remove_link (const char *);
_Bool file_exists_p (const char *);
_Bool file_non_directory_p (const char *);
wgint file_size (const char *);
int make_directory (const char *);
char *unique_name (const char *, _Bool);
FILE *unique_create (const char *, _Bool, char **);
FILE *fopen_excl (const char *, int);
char *file_merge (const char *, const char *);

int fnmatch_nocase (const char *, const char *, int);
_Bool acceptable (const char *);
_Bool accept_url (const char *);
_Bool accdir (const char *s);
char *suffix (const char *s);
_Bool match_tail (const char *, const char *, _Bool);
_Bool has_wildcards_p (const char *);

_Bool has_html_suffix_p (const char *);
...
_Bool run_with_timeout (double, void (*) (void *), void *);
void xsleep (double);
...
_Bool match_pcre_regex (const void *, const char *);


void *compile_posix_regex (const char *);
_Bool match_posix_regex (const void *, const char *);
...
void cleanup (void);
void defaults (void);
_Bool run_wgetrc (const char *file);
// # 62 "init.c" 2
// # 1 "host.h" 1
// # 41 "host.h"
// # 1 "../lib/netdb.h" 1
...
// # 1 "../lib/sys/uio.h" 1 3 4
// # 19 "../lib/sys/uio.h" 3 4
...
// # 579 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;

extern int _gl_cxxalias_dummy;
// # 607 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;



extern int _gl_cxxalias_dummy;
// # 636 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
// # 665 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;



extern int _gl_cxxalias_dummy;
// # 695 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
// # 724 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
// # 777 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;

extern int _gl_cxxalias_dummy;
// # 801 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;

extern int _gl_cxxalias_dummy;
// # 827 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
// # 920 "../lib/sys/socket.h" 3
extern int _gl_cxxalias_dummy;
...
// # 23 "../lib/arpa/inet.h" 3
// # 46 "../lib/arpa/inet.h" 3
...
// # 47 "../lib/arpa/inet.h" 2 3
// # 408 "../lib/arpa/inet.h" 3
extern int _gl_cxxalias_dummy;
...
_Bool address_list_contains (const struct address_list *, const ip_address *);
void address_list_set_faulty (struct address_list *, int);
void address_list_set_connected (struct address_list *);
_Bool address_list_connected_p (const struct address_list *);
void address_list_release (struct address_list *);

const char *print_address (const ip_address *);

_Bool is_valid_ipv6_address (const char *, const char *);


_Bool is_valid_ip_address (const char *name);

_Bool accept_domain (struct url *);
_Bool sufmatch (const char **, const char *);
...
struct url *url_parse (const char *, int *, struct iri *iri, _Bool percent_encode);
...
_Bool url_has_scheme (const char *);
_Bool url_valid_scheme (const char *);
...
_Bool are_urls_equal (const char *u1, const char *u2);
// # 36 "recur.h" 2
// # 45 "recur.h"
struct urlpos;
...
struct urlpos {
  ...
  unsigned int link_css_p :1;
  unsigned int link_expect_html :1;
  unsigned int link_expect_css :1;
...
_Bool res_match_path (const struct robot_specs *, const char *);

void res_register_specs (const char *, int, struct robot_specs *);
struct robot_specs *res_get_specs (const char *, int);

_Bool res_retrieve_file (const char *, char **, struct iri *);

_Bool is_robots_txt_url (const char *);
...
_Bool extract_param (const char **, param_token *, param_token *, char);
// # 69 "init.c" 2
// # 1 "retr.h" 1
// # 39 "retr.h"
...
extern _Bool output_stream_regular;
...
uerr_t retrieve_url (struct url *, const char *, char **, char **,
                     const char *, int *, _Bool, struct iri *, _Bool);
uerr_t retrieve_from_file (const char *, _Bool, int *);
...
_Bool url_uses_proxy (struct url *);

void set_local_file (const char **, const char *);

_Bool input_file_url (const char *);
// # 70 "init.c" 2
// # 1 "warc.h" 1
...
_Bool warc_write_request_record (char *url, char *timestamp_str,
  char *concurrent_to_uuid, ip_address *ip, FILE *body, off_t payload_offset);
_Bool warc_write_response_record (char *url, char *timestamp_str,
  char *concurrent_to_uuid, ip_address *ip, FILE *body, off_t payload_offset,
  char *mime_type, int response_code, char *redirect_location);
_Bool warc_write_resource_record (char *resource_uuid, const char *url,
...
// # 71 "init.c" 2
// # 80 "init.c"
static _Bool cmd_boolean (const char *, const char *, void *);
static _Bool cmd_bytes (const char *, const char *, void *);
static _Bool cmd_bytes_sum (const char *, const char *, void *);

static _Bool cmd_cert_type (const char *, const char *, void *);

static _Bool cmd_directory_vector (const char *, const char *, void *);
static _Bool cmd_number (const char *, const char *, void *);
static _Bool cmd_number_inf (const char *, const char *, void *);
static _Bool cmd_string (const char *, const char *, void *);
static _Bool cmd_file (const char *, const char *, void *);
static _Bool cmd_directory (const char *, const char *, void *);
static _Bool cmd_time (const char *, const char *, void *);
static _Bool cmd_vector (const char *, const char *, void *);

static _Bool cmd_spec_dirstruct (const char *, const char *, void *);
static _Bool cmd_spec_header (const char *, const char *, void *);
static _Bool cmd_spec_warc_header (const char *, const char *, void *);
static _Bool cmd_spec_htmlify (const char *, const char *, void *);
static _Bool cmd_spec_mirror (const char *, const char *, void *);
static _Bool cmd_spec_prefer_family (const char *, const char *, void *);
static _Bool cmd_spec_progress (const char *, const char *, void *);
static _Bool cmd_spec_recursive (const char *, const char *, void *);
static _Bool cmd_spec_regex_type (const char *, const char *, void *);
static _Bool cmd_spec_restrict_file_names (const char *, const char *, void *);
static _Bool cmd_spec_report_speed (const char *, const char *, void *);

static _Bool cmd_spec_secure_protocol (const char *, const char *, void *);

static _Bool cmd_spec_timeout (const char *, const char *, void *);
static _Bool cmd_spec_useragent (const char *, const char *, void *);
static _Bool cmd_spec_verbose (const char *, const char *, void *);
// # 120 "init.c"
static const struct {
  const char *name;
  void *place;
  _Bool (*action) (const char *, const char *, void *);
} commands[] = {
  ...
  { "alwaysrest", &opt.always_rest, cmd_boolean },
  ...
  { "ftppasswd", &opt.ftp_passwd, cmd_string },
  ...
  { "passwd", &opt.ftp_passwd, cmd_string },
  ...
  { "warcheader", ((void *)0), cmd_spec_warc_header },
...
command_by_name (const char *cmdname)
{
  ...
  int lo = 0, hi = (sizeof (commands) / sizeof ((commands)[0])) - 1;
...
defaults (void)
{
  ...
  opt.locale = ((void *)0);
  opt.encoding_remote = ((void *)0);

  opt.useservertimestamps = 1;
  opt.show_all_dns_entries = 0;

  opt.warc_maxsize = 0;

  opt.warc_compression_enabled = 1;



  opt.warc_digests_enabled = 1;
  opt.warc_cdx_enabled = 0;
  opt.warc_cdx_dedup_filename = ((void *)0);
  opt.warc_tempdir = ((void *)0);
  opt.warc_keep_log = 1;
}
...
static _Bool setval_internal (int, const char *, const char *);
static _Bool setval_internal_tilde (int, const char *, const char *);
  ...
  if (!fp)
    {
      fprintf (stderr, gettext ("%s: Cannot read %s (%s).\n"), exec_name,
               file, rpl_strerror ((*__errno_location ())));
      return 1;
    }
  ln = 1;
  while ((line = read_whole_line (fp)) != ((void *)0))
    {
      char *com = ((void *)0), *val = ((void *)0);
      int comind;
      ...
      if (!(com)) ; else free (com);
      if (!(val)) ; else free (val);
      free (line);
      ++ln;
    }
  fclose (fp);
...
initialize (void)
{
  ...
  else if (file_exists_p ("/usr/local/etc/wgetrc"))
...
parse_line (const char *line, char **com, char **val, int *comind)
{
  ...
  *val = strdupdelim (valstart, valend);
  ...
  do { const char *BTA_beg = (cmdstart); int BTA_len = (cmdend) - BTA_beg; char **BTA_dest = &(cmdcopy); *BTA_dest = __builtin_alloca (BTA_len + 1); memcpy (*BTA_dest, BTA_beg, BTA_len); (*BTA_dest)[BTA_len] = '\0'; } while (0);
  dehyphen (cmdcopy);
...
{
  ((0 <= comind && ((size_t) comind) < (sizeof (commands) / sizeof ((commands)[0]))) ? (void) (0) : (__assert_fail ("0 <= comind && ((size_t) comind) < (sizeof (commands) / sizeof ((commands)[0]))", "init.c", 788, __PRETTY_FUNCTION__), (void) (0)));
  do { if (__builtin_expect ((opt.debug), 0)) { debug_logprintf ("Setting %s (%s) to %s\n", com, commands[comind].name, val); } } while (0);
...
setoptval (const char *com, const char *val, const char *optname)
{
  ...
  char *dd_optname = (char *) __builtin_alloca (2 + strlen (optname) + 1);
  dd_optname[0] = '-';
  dd_optname[1] = '-';
  strcpy (dd_optname + 2, optname);

  ((val != ((void *)0)) ? (void) (0) : (__assert_fail ("val != ((void *)0)", "init.c", 843, __PRETTY_FUNCTION__), (void) (0)));
...
static _Bool decode_string (const char *, const struct decode_item *, int, int *);
static _Bool simple_atoi (const char *, const char *, int *);
static _Bool simple_atof (const char *, const char *, double *);
// # 897 "init.c"
static _Bool
cmd_boolean (const char *com, const char *val, void *place)
{
  ...
  if ((c_tolower((val)[0]) == ('o') && c_tolower((val)[1]) == ('n') && (val)[2] == '\0') || (c_tolower((val)[0]) == ('y') && c_tolower((val)[1]) == ('e') && c_tolower((val)[2]) == ('s') && (val)[3] == '\0') || (c_tolower((val)[0]) == ('1') && (val)[1] == '\0'))

    value = 1;
  else if ((c_tolower((val)[0]) == ('o') && c_tolower((val)[1]) == ('f') && c_tolower((val)[2]) == ('f') && (val)[3] == '\0') || (c_tolower((val)[0]) == ('n') && c_tolower((val)[1]) == ('o') && (val)[2] == '\0') || (c_tolower((val)[0]) == ('0') && (val)[1] == '\0'))

    value = 0;
  else
    {
      fprintf (stderr,
               gettext ("%s: %s: Invalid boolean %s; use `on' or `off'.\n"),
...
static _Bool check_user_specified_header (const char *);
...
cmd_spec_progress (const char *com, const char *val, void *place_ignored)
{
  ...
  if (!(opt.progress_type)) ; else free (opt.progress_type);
  ...
  do
    {
      ...
      else if (((end) - (val) == sizeof ("nocontrol") - 1 && !memcmp (val, "nocontrol", sizeof ("nocontrol") - 1)))
        restrict_ctrl = 0;
      else if (((end) - (val) == sizeof ("ascii") - 1 && !memcmp (val, "ascii", sizeof ("ascii") - 1)))
        restrict_nonascii = 1;
      else
        {
        fprintf(stderr,
...
cmd_spec_useragent (const char *com, const char *val, void *place_ignored)
{
  ...
  if (!(opt.useragent)) ; else free (opt.useragent);
