...
static testcall alltests[] = {
    ...
    {"omp_get_num_threads", check_omp_get_num_threads,
     crosscheck_omp_get_num_threads},
    ...
    {"section_reduction", check_section_reduction,
     crosscheck_section_reduction},
    {"section_private", check_section_private, crosscheck_section_private},
    {"section_firstprivate", check_section_firstprivate,
     crosscheck_section_firstprivate},
    {"section_lastprivate", check_section_lastprivate,
     crosscheck_section_lastprivate},
    ...
    {"parallel_for_ordered", check_parallel_for_ordered,
     crosscheck_parallel_for_ordered},
    {"parallel_for_reduction", check_parallel_for_reduction,
     crosscheck_parallel_for_reduction},
    {"parallel_for_private", check_parallel_for_private,
     crosscheck_parallel_for_private},
    {"parallel_for_firstprivate", check_parallel_for_firstprivate,
     crosscheck_parallel_for_firstprivate},
    {"parallel_for_lastprivate", check_parallel_for_lastprivate,
     crosscheck_parallel_for_lastprivate},
    {"parallel_section_reduction", check_parallel_section_reduction,
     crosscheck_parallel_section_reduction},
    {"parallel_section_private", check_parallel_section_private,
     crosscheck_parallel_section_private},
    {"parallel_section_firstprivate", check_parallel_section_firstprivate,
     crosscheck_parallel_section_firstprivate},
    {"parallel_section_lastprivate", check_parallel_section_lastprivate,
     crosscheck_parallel_section_lastprivate},
    {"omp_master_thread", check_omp_master_thread,
     crosscheck_omp_master_thread},
    ...
    {"omp_threadprivate", check_omp_threadprivate,
     crosscheck_omp_threadprivate},
    ...
    {"omp_nest_testlock", check_omp_nest_testlock,
     crosscheck_omp_nest_testlock},
    ...
    {"single_copyprivate", check_single_copyprivate,
     crosscheck_single_copyprivate},
    {"for_schedule_static", check_for_schedule_static,
     crosscheck_for_schedule_static},
    {"for_schedule_dynamic", check_for_schedule_dynamic,
     crosscheck_for_schedule_dynamic},
    {"for_schedule_guided", check_for_schedule_guided,
...
int main(int argc, char **argv) {
  ...
  while (alltests[i].pass) {
    ...
    if (result) {
      fprintf(logFile,
              "Directiv worked without errors.\nCrosschecks verified this "
              "result with %5.2f%% certainty.\n",
              100.0 * crossfailed / N);
  ...
  printf("\n\n Performed a total of %d tests, %d failed and %d successful with "
         "%d cross checked\nFor detailled inforamtion on the tests see the "
         "logfile: (%s).\n",
         i, failed, success, crosschecked, logFileName);
  printf("Also check failed.compilation for tests which did not pass the "
         "compilation.\n");
  fprintf(logFile,
          "\n\n Performed a total of %d tests, %d failed and %d successful "
          "with %d cross checked\n",
