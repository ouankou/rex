// This example code demonstrates the a test code that used the
// std::unique_ptr<> type. I think that this is C++11 specific and might not
// have any C++14 specfic parts.
...
UserQueues::UserQueues() : _jobDeques() {
