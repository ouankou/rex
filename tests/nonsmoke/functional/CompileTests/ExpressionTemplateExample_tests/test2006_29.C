...
// The processing of this file takes a very long time :-)
// About 30 minutes with ROSE on my machine.
...
template <typename Right> struct X<double, Times, Right> {
...
public:
  ...
  inline double Give(int i) const { return data()[i]; }
