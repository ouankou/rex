...
// Turn ON the PPP macro
#define PPP

// the collection of header files required 
// before the P++ objects can be defined are 
// contained in P++_headers.h.  This simplifies
// the implementation.  Depending on if we 
// are compiling P++ or and P++ application
// the collection of required files are different.
#include <P++_headers.h>
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        doubleArray ( const double* Array_Data_Pointer,
	   doubleArray_Descriptor_Type* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        floatArray ( const float* Array_Data_Pointer,
	   floatArray_Descriptor_Type* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
...
// elif defined(APP)
    ...
    //! This function is called in lazy_operand.C!
        intArray ( const int* Array_Data_Pointer,
	   intArray_Descriptor_Type* Array_Descriptor_Pointer,
           Operand_Storage* Array_Storage_Pointer );
#endif
#endif
...
#if !USE_SAGE
// Need to INCLUDE the Serial_A++ headers before including the P++/inline_func.h
// include <inline_func.h>
#endif
// endif

// Turn OFF the PPP macro for compilation of non P++ source code
#if defined(COMPILE_SERIAL_APP)
#undef PPP
#endif
 
#endif  /* !defined(_PPP_ARRAY_H) */
