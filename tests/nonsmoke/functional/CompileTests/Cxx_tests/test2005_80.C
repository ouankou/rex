...
and}254: ../rose_linux_gcc3.3.2/bin/identityTranslator -c rctest.cc
sourceFile = rctest.cc Found a ".cc" source file!
"/home/chand/scratch/rose/rose_linux_gcc3.3.2/g++_HEADERS/hdrs1/ostream",
line 206: error: more than one operator "||" matches these operands: function
"operator||(int, const intArray &)" function "operator||(const intArray &,
int)" operand types are: std::_Ios_Fmtflags || std::_Ios_Fmtflags if (__fmt &
ios_base::oct || __fmt & ios_base::hex)
                                  ^
          detected during instantiation of "std::basic_ostream<_CharT,
                    ...
                    _Traits=std::char_traits<char>]" at line 19 of
"rctest.cc"
