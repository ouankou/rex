...
int foo()
  ...
  *x.operator->();
  ...
  // DQ (4/9/2013): This fails because of the precedence issue of member
  // functions that should have the asociated presendence of their overloaded
  // operators). x.operator+(x);
