...
namespace N {
// If the function is defined local to the namespace then we don't require the
// "::" qualification in the friend declaration void OUT__1__7037__(int
// *resultp__,const void *this__ptr__p__);

class A {
  // public: friend void ::N::OUT__1__7037__(int *resultp__,const void
  // *this__ptr__p__);
public:
  friend void ::OUT__1__7037__(int *resultp__, const void *this__ptr__p__);

private:
  inline int foo() const { return 7; }

  inline int bar() const { return (this)->foo() / 2; }
