/* Test substitution of varargs with something that would preserve them in the
   ...
   This test code is similar to test2006_91.C but this is tested using
   --rose:C_only (C instead of C+++).

*/

// #include "test2006_91.C"
// code copied from test2006_91.C (can't use include since the generated code
// would just have the include directive)
#include <stdarg.h>
