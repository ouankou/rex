...
#warning                                                                       \
    "This is the ROSE C mode, independent of the setting of the __cplusplus Macro"
#else
...
#else
#error                                                                         \
    "This is an unknown ROSE language mode, independent of the setting of the __cplusplus Macro"
#endif
#endif
// #else
//  #warning "ROSE_LANGUAGE_MODE is defined for internal ROSE use only, and is
//  not defined for the vendor compiler.
#endif
