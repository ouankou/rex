              ...
              typename detail::prevent_eti<
                  ...
                  typename boost::detail::allocator::rebind_to<
                      Allocator, typename detail::multi_index_node_type<
                                     ...
                                     Allocator>::type>::type>::type::pointer,
...
template <> struct uintptr_candidates<4> {
  typedef unsigned int type;
};
...
struct uintptr_aux {
  ...
  BOOST_STATIC_CONSTANT(
      int, index = sizeof(void *) == sizeof(uintptr_candidates<0>::type)   ? 0
                   ...
                   : sizeof(void *) == sizeof(uintptr_candidates<4>::type)
                       ? 4
                       : -1);
...
template <typename Allocator> struct ordered_index_node_std_base {
  typedef typename prevent_eti<
      Allocator,
      typename boost::detail::allocator::rebind_to<
          Allocator, ordered_index_node_impl<Allocator>>::type>::type::pointer
      pointer;
  typedef typename prevent_eti<
      Allocator, typename boost::detail::allocator::rebind_to<
                     Allocator, ordered_index_node_impl<Allocator>>::type>::
...
template <typename Allocator> struct ordered_index_node_compressed_base {
...
struct ordered_index_node_impl_base :
    ...
    mpl::if_c<
        !(has_uintptr_type::value) ||
            (alignment_of<
                 ordered_index_node_compressed_base<Allocator>>::value %
             2) ||
            !(is_same<typename prevent_eti<
                          Allocator,
                          typename boost::detail::allocator::rebind_to<
                              Allocator, ordered_index_node_impl<Allocator>>::
                              type>::type::pointer,
...
struct ordered_index_node_trampoline
    : prevent_eti<
          ...
          ordered_index_node_impl<typename boost::detail::allocator::rebind_to<
              typename Super::allocator_type, char>::type>>::type {
  typedef typename prevent_eti<
      Super,
      ordered_index_node_impl<typename boost::detail::allocator::rebind_to<
...
template <typename KeyFromValue, typename Compare, typename SuperMeta,
          typename TagList, typename Category>
class ordered_index
...
template <typename FromType, typename ToType> struct bidirectional_map {
  typedef std::pair<FromType, ToType> value_type;
  typedef boost::multi_index::multi_index_container<
      value_type, boost::multi_index::indexed_by<
                      boost::multi_index::ordered_unique<
                          boost::multi_index::tag<from>,
                          boost::multi_index::member<value_type, FromType,
                                                     &value_type::first>>,
                      boost::multi_index::ordered_non_unique<
                          boost::multi_index::tag<to>,
                          boost::multi_index::member<value_type, ToType,
                                                     &value_type::second>>>>
      type;
};
