...
// correctly by legacy frontend for C++, but is a bug in legacy frontend 3.3 for
// C we now correct for this bug by resetting the non-defining declaration's
// scope when we see the defining declaration (and have correctly nailed down
// its scope).
