...
class AsmUnparser 
   {
     public:
         ...
         // DQ (7/3/2013): This code will compile fine with ROSE configured to
         // be a GNU 4.4.5 compiler if this line is commented out. Uncommented
         // the file will compile only if ROSE is configured to be a GNU 4.2.4
