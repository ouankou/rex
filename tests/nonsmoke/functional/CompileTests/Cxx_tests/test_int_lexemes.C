...
char func_char(char a) { return a * a; }

signed char func_signed_char(signed char a) { return a * a; }

unsigned char func_unsigned_char(unsigned char a) { return a * a; }
...
short func_short(short a) { return a * a; }

unsigned short func_unsigned_short(unsigned short a) { return a * a; }

// The ints
int func_int(int a) { return a * a; }

unsigned int func_unsigned_int(unsigned int a) { return a * a; }

// The longs
long func_long(long a) { return a * a; }

unsigned long func_unsigned_long(unsigned long a) { return a * a; }

// The long longs
long long func_long_long(long long a) { return a * a; }
