...
/*
Lvalue-to-rvalue, array-to-pointer, and function-to-pointer conversions will not
be applied to expr. For example, the output of the following example will be int
[10], not int *:
