...
class Block 
   {
     public:
       ...
       // DQ (3/1/2017): This is a GNU 4.8 issue where uint64_t is not defined.
       // So fix this by making an exception for the GNU 4.8 compiler support in
       // ROSE. This issue was identified in ROSE Matrix testing for 2/28/2017.
