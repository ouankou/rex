...
namespace std __attribute__((__visibility__("default"))) {
  ...
  __ostream_insert(basic_ostream<char, class std::char_traits<char>> & __out,
                   const char *__s, streamsize __n);
  extern template basic_ostream<wchar_t, class std::char_traits<wchar_t>> &
  __ostream_insert(basic_ostream<wchar_t, class std::char_traits<wchar_t>> &
                       __out,
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  extern template basic_ostream<char, class std::char_traits<char>> &
  std::operator<<(basic_ostream<char, class std::char_traits<char>> &__os,
                  const basic_string<char, class std::char_traits<char>,
                                     class std::allocator<char>> &__str);
  extern template basic_istream<char, class std::char_traits<char>> &getline(
      basic_istream<char, class std::char_traits<char>> & __is,
      basic_string<char, class std::char_traits<char>,
                   class std::allocator<char>> &
          __str);
  extern template class basic_string<wchar_t>;
  extern template basic_istream<wchar_t, class std::char_traits<wchar_t>> &
  std::operator>>(basic_istream<wchar_t, class std::char_traits<wchar_t>> &__in,
                  basic_string<wchar_t, class std::char_traits<wchar_t>,
                               class std::allocator<wchar_t>> &__str);
  extern template basic_ostream<wchar_t, class std::char_traits<wchar_t>> &
  std::operator<<(basic_ostream<wchar_t, class std::char_traits<wchar_t>> &__os,
                  const basic_string<wchar_t, class std::char_traits<wchar_t>,
                                     class std::allocator<wchar_t>> &__str);
  extern template basic_istream<wchar_t, class std::char_traits<wchar_t>>
      &getline(basic_istream<wchar_t, class std::char_traits<wchar_t>> & __is,
               basic_string<wchar_t, class std::char_traits<wchar_t>,
