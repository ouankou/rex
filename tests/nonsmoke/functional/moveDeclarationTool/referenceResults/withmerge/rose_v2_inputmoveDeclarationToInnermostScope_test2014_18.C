...
extern wchar_t *wcsncpy(wchar_t *__restrict __dest,
                        __const wchar_t *__restrict __src, size_t __n) throw();
...
extern int wcsncmp(__const wchar_t *__s1, __const wchar_t *__s2,
...
extern int wcscoll_l(__const wchar_t *__s1, __const wchar_t *__s2,
                     __locale_t __loc) throw();
extern size_t wcsxfrm_l(wchar_t *__s1, __const wchar_t *__s2, size_t __n,
                        __locale_t __loc) throw();
...
extern "C++" wchar_t *wcschr(wchar_t *__wcs,
    ...
    __attribute__((__pure__));
extern "C++" __const wchar_t *wcschr(__const wchar_t *__wcs,
                                     wchar_t __wc) throw() __asm("wcschr")
    __attribute__((__pure__));
extern "C++" wchar_t *wcsrchr(wchar_t *__wcs,
                              wchar_t __wc) throw() __asm("wcsrchr")
    __attribute__((__pure__));
extern "C++" __const wchar_t *wcsrchr(__const wchar_t *__wcs,
                                      wchar_t __wc) throw() __asm("wcsrchr")
    __attribute__((__pure__));

extern wchar_t *wcschrnul(__const wchar_t *__s, wchar_t __wc) throw()
    __attribute__((__pure__));
...
extern size_t wcsspn(__const wchar_t *__wcs, __const wchar_t *__accept) throw()
    __attribute__((__pure__));
extern "C++" wchar_t *
wcspbrk(wchar_t *__wcs, __const wchar_t *__accept) throw() __asm("wcspbrk")
    __attribute__((__pure__));
extern "C++" __const wchar_t *
wcspbrk(__const wchar_t *__wcs,
        __const wchar_t *__accept) throw() __asm("wcspbrk")
    __attribute__((__pure__));
extern "C++" wchar_t *wcsstr(wchar_t *__haystack,
                             __const wchar_t *__needle) throw() __asm("wcsstr")
    __attribute__((__pure__));
extern "C++" __const wchar_t *
wcsstr(__const wchar_t *__haystack,
       __const wchar_t *__needle) throw() __asm("wcsstr")
    __attribute__((__pure__));
...
extern "C++" wchar_t *wcswcs(wchar_t *__haystack,
                             __const wchar_t *__needle) throw() __asm("wcswcs")
    __attribute__((__pure__));
extern "C++" __const wchar_t *
wcswcs(__const wchar_t *__haystack,
       __const wchar_t *__needle) throw() __asm("wcswcs")
    __attribute__((__pure__));
...
extern wchar_t *wmemcpy(wchar_t *__restrict __s1,
                        __const wchar_t *__restrict __s2, size_t __n) throw();
extern wchar_t *wmemmove(wchar_t *__s1, __const wchar_t *__s2,
                         size_t __n) throw();
...
extern size_t mbrtowc(wchar_t *__restrict __pwc, __const char *__restrict __s,
...
extern size_t wcsnrtombs(char *__restrict __dst,
                         __const wchar_t **__restrict __src, size_t __nwc,
                         size_t __len, mbstate_t *__restrict __ps) throw();
...
__extension__ extern long long int wcstoll(__const wchar_t *__restrict __nptr,
                                           wchar_t **__restrict __endptr,
                                           int __base) throw();
__extension__ extern unsigned long long int
wcstoull(__const wchar_t *__restrict __nptr, wchar_t **__restrict __endptr,
         int __base) throw();

__extension__ extern long long int wcstoq(__const wchar_t *__restrict __nptr,
                                          wchar_t **__restrict __endptr,
                                          int __base) throw();
__extension__ extern unsigned long long int
wcstouq(__const wchar_t *__restrict __nptr, wchar_t **__restrict __endptr,
        int __base) throw();
...
extern unsigned long int wcstoul_l(__const wchar_t *__restrict __nptr,
                                   wchar_t **__restrict __endptr, int __base,
                                   __locale_t __loc) throw();
__extension__ extern long long int wcstoll_l(__const wchar_t *__restrict __nptr,
                                             wchar_t **__restrict __endptr,
                                             int __base,
                                             __locale_t __loc) throw();
__extension__ extern unsigned long long int
wcstoull_l(__const wchar_t *__restrict __nptr, wchar_t **__restrict __endptr,
           int __base, __locale_t __loc) throw();
extern double wcstod_l(__const wchar_t *__restrict __nptr,
                       wchar_t **__restrict __endptr, __locale_t __loc) throw();
...
extern int swprintf(wchar_t *__restrict __s, size_t __n,
                    __const wchar_t *__restrict __format, ...) throw();
...
extern int vfwscanf(__FILE *__restrict __s,
                    __const wchar_t *__restrict __format, __gnuc_va_list __arg);
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  inline _OI __copy_move_a(_II __first, _II __last, _OI __result) {
    ...
    const bool __simple =
        (__is_pod(_ValueTypeI) && __is_pointer<_II>::__value &&
  ...
  inline _OI __copy_move_a2(_II __first, _II __last, _OI __result) {
    return _OI(
        std::__copy_move_a<_IsMove>(std::__niter_base<_II>::__b(__first),
  ...
  inline _BI2 __copy_move_backward_a(_BI1 __first, _BI1 __last, _BI2 __result) {
    ...
    const bool __simple =
        (__is_pod(_ValueType1) && __is_pointer<_BI1>::__value &&
  ...
  inline bool __equal_aux(_II1 __first1, _II1 __last1, _II2 __first2) {
    ...
    const bool __simple =
        (__is_integer<_ValueType1>::__value && __is_pointer<_II1>::__value &&
...
extern __const unsigned short int **__ctype_b_loc(void) throw()
    __attribute__((__const));
extern __const __int32_t **__ctype_tolower_loc(void) throw()
    __attribute__((__const));
extern __const __int32_t **__ctype_toupper_loc(void) throw()
    __attribute__((__const));
...
extern "C" {
extern "C" int sched_setparam(__pid_t __pid, const struct sched_param *__param);
...
extern char *strptime(__const char *__restrict __s,
                      __const char *__restrict __fmt, struct tm *__tp) throw();
...
extern int clock_settime(clockid_t __clock_id,
                         __const struct timespec *__tp) throw();
...
extern int pthread_attr_setguardsize(pthread_attr_t *__attr,
    ...
    __attribute__((__nonnull__(1)));
extern int
pthread_attr_getschedparam(__const pthread_attr_t *__restrict __attr,
                           struct sched_param *__restrict __param) throw()
    __attribute__((__nonnull__(1, 2)));
extern int pthread_attr_setschedparam(
    pthread_attr_t *__restrict __attr,
    __const struct sched_param *__restrict __param) throw()
    __attribute__((__nonnull__(1, 2)));
extern int
...
extern int pthread_mutex_init(pthread_mutex_t *__mutex,
                              __const pthread_mutexattr_t *__mutexattr) throw()
    __attribute__((__nonnull__(1)));
...
pthread_mutex_timedlock(pthread_mutex_t *__restrict __mutex,
                        __const struct timespec *__restrict __abstime) throw()
    __attribute__((__nonnull__(1, 2)));
...
pthread_rwlock_init(pthread_rwlock_t *__restrict __rwlock,
                    __const pthread_rwlockattr_t *__restrict __attr) throw()
    __attribute__((__nonnull__(1)));
...
pthread_cond_init(pthread_cond_t *__restrict __cond,
                  __const pthread_condattr_t *__restrict __cond_attr) throw()
    __attribute__((__nonnull__(1)));
...
extern int euidaccess(__const char *__name, int __type) throw()
    __attribute__((__nonnull__(1)));
extern int eaccess(__const char *__name, int __type) throw()
    __attribute__((__nonnull__(1)));
extern int faccessat(int __fd, __const char *__file, int __type,
                     int __flag) throw() __attribute__((__nonnull__(2)));
...
extern int lchown(__const char *__file, __uid_t __owner,
                  __gid_t __group) throw() __attribute__((__nonnull__(1)));
extern int fchownat(int __fd, __const char *__file, __uid_t __owner,
                    __gid_t __group, int __flag) throw()
    __attribute__((__nonnull__(2)));
...
extern int linkat(int __fromfd, __const char *__from, int __tofd,
                  __const char *__to, int __flags) throw()
    __attribute__((__nonnull__(2, 4)));
extern int symlink(__const char *__from, __const char *__to) throw()
    __attribute__((__nonnull__(1, 2)));
extern ssize_t readlink(__const char *__restrict __path, char *__restrict __buf,
                        size_t __len) throw()
    __attribute__((__nonnull__(1, 2)));
extern int symlinkat(__const char *__from, int __tofd,
                     __const char *__to) throw()
    __attribute__((__nonnull__(1, 3)));
extern ssize_t readlinkat(int __fd, __const char *__restrict __path,
                          char *__restrict __buf, size_t __len) throw()
    __attribute__((__nonnull__(2, 3)));
extern int unlink(__const char *__name) throw() __attribute__((__nonnull__(1)));
extern int unlinkat(int __fd, __const char *__name, int __flag) throw()
    __attribute__((__nonnull__(2)));
...
namespace __gnu_cxx __attribute__((__visibility__("default"))) {
  ...
  static inline void __attribute__((__unused__)) __atomic_add_dispatch(
...
public:
  ...
  ~new_allocator() {}
  typename __gnu_cxx::new_allocator<_Tp>::pointer address(reference __x) const {
    return &__x;
  }
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  extern template basic_ostream<char, std::char_traits<char>> &__ostream_insert(
      basic_ostream<char, std::char_traits<char>> & __out, const char *__s,
      streamsize __n);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &
  __ostream_insert(basic_ostream<wchar_t, std::char_traits<wchar_t>> & __out,
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__os,
      const basic_string<char, std::char_traits<char>, std::allocator<char>>
          &__str);
  extern template basic_istream<char, std::char_traits<char>> &getline(
      basic_istream<char, std::char_traits<char>> & __is,
      basic_string<char, std::char_traits<char>, std::allocator<char>> & __str);
  extern template class basic_string<wchar_t>;
  extern template basic_istream<wchar_t, std::char_traits<wchar_t>> &
  std::operator>>(basic_istream<wchar_t, std::char_traits<wchar_t>> &__in,
                  basic_string<wchar_t, std::char_traits<wchar_t>,
                               std::allocator<wchar_t>> &__str);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &
  std::operator<<(basic_ostream<wchar_t, std::char_traits<wchar_t>> &__os,
                  const basic_string<wchar_t, std::char_traits<wchar_t>,
                                     std::allocator<wchar_t>> &__str);
  extern template basic_istream<wchar_t, std::char_traits<wchar_t>> &getline(
      basic_istream<wchar_t, std::char_traits<wchar_t>> & __is,
      basic_string<wchar_t, std::char_traits<wchar_t>,
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  template <typename _Facet>
  locale locale::combine(const std::locale &__other) const {
  ...
  template <typename _CharT>
  typename collate<_CharT>::string_type std::collate<_CharT>::do_transform(
  ...
  extern template const collate<char> &use_facet(const locale &__loc);
  extern template bool has_facet<class std::collate<char>>(const locale &__loc);
  extern template class collate<wchar_t>;
  extern template class collate_byname<wchar_t>;
  extern template const collate<wchar_t> &use_facet(const locale &__loc);
  extern template bool has_facet<class std::collate<wchar_t>>(
      const locale &__loc);
} // namespace std
namespace std __attribute__((__visibility__("default"))) {
  enum _Ios_Fmtflags {
  ...
  protected:
    ...
    struct _Callback_list {
      ...
      int _M_index;
      _Atomic_word _M_refcount;
      _Callback_list(typename ios_base::event_callback __fn, int __index,
                     ios_base::_Callback_list *__cb)
...
extern wctrans_t wctrans_l(__const char *__property,
                           __locale_t __locale) throw();
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  template <typename _CharT> struct __numpunct_cache : public locale::facet {
    ...
    __numpunct_cache(size_t __refs = 0)
        : facet(__refs), _M_grouping(__null), _M_grouping_size(0),
          _M_use_grouping(false), _M_truename(__null), _M_truename_size(0),
          _M_falsename(__null), _M_falsename_size(0),
  ...
  public:
    static locale::id id;
    explicit numpunct(size_t __refs = 0) : facet(__refs), _M_data(__null) {
  ...
  protected:
    ...
    virtual iter_type do_get(iter_type, iter_type, ios_base &,
                             ios_base::iostate &__err, float &) const;
    virtual iter_type do_get(iter_type, iter_type, ios_base &,
                             ios_base::iostate &__err, double &) const;
    virtual iter_type do_get(iter_type, iter_type, ios_base &,
                             ios_base::iostate &__err, long double &) const;
    virtual iter_type do_get(iter_type, iter_type, ios_base &,
                             ios_base::iostate &__err, void *&) const;
  };
  template <typename _CharT, typename _InIter>
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  extern template const ctype<char> &use_facet(const locale &__loc);
  extern template const numpunct<char> &use_facet(const locale &__loc);
  extern template const num_put<char> &use_facet(const locale &__loc);
  extern template const num_get<char> &use_facet(const locale &__loc);
  extern template bool has_facet<class std::numpunct<char>>(
      const locale &__loc);
  extern template bool has_facet<class std::num_put<char>>(const locale &__loc);
  extern template bool has_facet<class std::num_get<char>>(const locale &__loc);
  extern template class numpunct<wchar_t>;
  extern template class numpunct_byname<wchar_t>;
  extern template class num_get<wchar_t>;
  extern template class num_put<wchar_t>;
  extern template class ctype_byname<wchar_t>;
  extern template const ctype<wchar_t> &use_facet(const locale &__loc);
  extern template const numpunct<wchar_t> &use_facet(const locale &__loc);
  extern template const num_put<wchar_t> &use_facet(const locale &__loc);
  extern template const num_get<wchar_t> &use_facet(const locale &__loc);
  extern template bool has_facet<std::ctype<wchar_t>>(const locale &__loc);
  extern template bool has_facet<class std::numpunct<wchar_t>>(
      const locale &__loc);
  extern template bool has_facet<class std::num_put<wchar_t>>(
      const locale &__loc);
  extern template bool has_facet<class std::num_get<wchar_t>>(
      const locale &__loc);
} // namespace std
namespace std __attribute__((__visibility__("default"))) {
  template <typename _Facet>
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  basic_ostream<_CharT, _Traits> &basic_ostream<_CharT, _Traits>::_M_insert(
    ...
    sentry __cerb = *(this);
    if (__cerb) {
      ios_base::iostate __err = typename ios_base::iostate(ios_base::goodbit);
      try {
  ...
  template <typename _CharT, typename _Traits>
  basic_ostream<_CharT, _Traits> &std::basic_ostream<_CharT, _Traits>::seekp(
      off_type __off, typename ios_base::seekdir __dir) {
    ios_base::iostate __err = typename ios_base::iostate(ios_base::goodbit);
    try {
      if (!(this)->fail()) {
        const pos_type __p =
  ...
  extern template basic_ostream<char, std::char_traits<char>> &endl(
      basic_ostream<char, std::char_traits<char>> & __os);
  extern template basic_ostream<char, std::char_traits<char>> &ends(
      basic_ostream<char, std::char_traits<char>> & __os);
  extern template basic_ostream<char, std::char_traits<char>> &flush(
      basic_ostream<char, std::char_traits<char>> & __os);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out, char __c);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out, unsigned char __c);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out, signed char __c);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out, const char *__s);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out,
      const unsigned char *__s);
  extern template basic_ostream<char, std::char_traits<char>> &std::operator<<(
      basic_ostream<char, std::char_traits<char>> &__out,
      const signed char *__s);
  extern template class basic_ostream<wchar_t>;
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &endl(
      basic_ostream<wchar_t, std::char_traits<wchar_t>> & __os);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &ends(
      basic_ostream<wchar_t, std::char_traits<wchar_t>> & __os);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &flush(
      basic_ostream<wchar_t, std::char_traits<wchar_t>> & __os);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &
  std::operator<<(basic_ostream<wchar_t, std::char_traits<wchar_t>> &__out,
                  wchar_t __c);
  extern template basic_ostream<wchar_t, std::char_traits<wchar_t>> &
  std::operator<<(basic_ostream<wchar_t, std::char_traits<wchar_t>> &__out,
                  char __c);
...
namespace std __attribute__((__visibility__("default"))) {
  ...
  extern template basic_istream<char, std::char_traits<char>> &ws(
      basic_istream<char, std::char_traits<char>> & __in);
  extern template basic_istream<char, std::char_traits<char>> &std::operator>>(
      basic_istream<char, std::char_traits<char>> &__in, char &__c);
  extern template basic_istream<char, std::char_traits<char>> &std::operator>>(
      basic_istream<char, std::char_traits<char>> &__in, unsigned char &__c);
  extern template basic_istream<char, std::char_traits<char>> &std::operator>>(
      basic_istream<char, std::char_traits<char>> &__in, signed char &__c);
  extern template basic_istream<char, std::char_traits<char>> &std::operator>>(
      basic_istream<char, std::char_traits<char>> &__in, unsigned char *__s);
  extern template basic_istream<char, std::char_traits<char>> &std::operator>>(
      basic_istream<char, std::char_traits<char>> &__in, signed char *__s);
  extern template class basic_iostream<char>;
  extern template class basic_istream<wchar_t>;
  extern template basic_istream<wchar_t, std::char_traits<wchar_t>> &ws(
      basic_istream<wchar_t, std::char_traits<wchar_t>> & __in);
  extern template basic_istream<wchar_t, std::char_traits<wchar_t>> &
  std::operator>>(basic_istream<wchar_t, std::char_traits<wchar_t>> &__in,
                  wchar_t &__c);
  extern template basic_istream<wchar_t, std::char_traits<wchar_t>> &
