...
public:
  ...
  // Provide command line option processing: arg will be the options passed to
  // this plugin
...
static Rose::PluginRegistry::Add<PrintNamesAction>
    X("print-names", "print node names in pre-order");
