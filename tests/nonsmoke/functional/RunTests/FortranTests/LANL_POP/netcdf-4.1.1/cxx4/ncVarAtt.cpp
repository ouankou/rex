...
// comparator operator
bool operator<(const NcVarAtt &lhs, const NcVarAtt &rhs) { return false; }

// comparator operator
bool operator>(const NcVarAtt &lhs, const NcVarAtt &rhs) { return true; }
} // namespace netCDF
...
NcVar NcVarAtt::getParentVar() const { return NcVar(groupId, varId); }
