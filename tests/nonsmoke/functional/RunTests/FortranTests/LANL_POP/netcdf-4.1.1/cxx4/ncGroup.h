...
public:
  /*!
    The enumeration list contains the options for selecting groups (used for
    returned set of NcGroup objects).
  */
  enum GroupLocation {
    ChildrenGrps, //!< Select from the set of children in the current group.
    ParentsGrps,  //!< Select from set of parent groups (excludes the current
                  //!< group).
    ChildrenOfChildrenGrps, //!< Select from set of all children of children in
                            //!< the current group.
    AllChildrenGrps, //!< Select from set of all children of the current group
                     //!< and beneath.
    ParentsAndCurrentGrps, //!< Select from set of parent groups(includes the
                           //!< current group).
    AllGrps //!< Select from set of parent groups, current groups and all the
            //!< children beneath.
  };
  ...
  */
  ...
  /*! Gets the group name. */
  /*!
    Method will throw an netCDF::exceptions::NcNullgrp exception if the group is
    null (ie NcGroup::isNull()=true).
    \param fullName If true then the full name is returned with subgroups
    separated by a forward slash "/" (default is false)
  ...
  */
  ...
  /*!
    ...
    Method will throw an netCDF::exceptions::NcNullgrp exception if the  group
    is null (ie NcGroup::isNull()=true). If the current root is the parent
    group, then return a null group.
  */
  ...
  */
  ...
  /*!
    ...
    null (ie NcGroup::isNull()=true).
    \param location Enumeration type controlling the groups to search.
    \return         A STL multimap object, containing pairs of <attribute name,
    NcGroup object> entities.
  */
  std::multimap<std::string, NcGroup>
  getGroups(NcGroup::GroupLocation location = ChildrenGrps) const;
  ...
  */
  ...
  /*!
    ...
    \param location   Enumeration type controlling the groups to search.
    \return      An NcGroup object. If there are multiple objects indentied with
    the same name, the object closest to the current group is returned. If no
    valid object is found , a \ref NcGroup::isNull "null node" is returned.
  */
  NcGroup getGroup(const std::string &name,
                   NcGroup::GroupLocation location = ChildrenGrps) const;
  ...
  */
  ...
  /*!
    ...
    \param location Enumeration type controlling the groups to search.
    \return         A STL multimap object, containing pairs of <attribute name,
    NcVar object> entities.
  */
  std::multimap<std::string, NcVar>
  getVars(NcGroup::Location location = Current) const;
   ...
   */
  std::set<NcVar> getVars(const std::string &name,
                          NcGroup::Location location = Current) const;

  /*!
    Gets the named NcVar object..
    \param name     Variable name.
    \param location Enumeration type controlling the groups to search.
    \return         A NcVar object. If there are multiple objects indentied with
    the same name, the object closest  to the current group is returned. If no
    valid object is found , a \ref NcVar::isNull "null node" is returned.
   */
  ...
  /*!
    ...
    The NcType and NcDim objects must be non-null, and be defined in either the
    current group or a parent group. An NcNullType exception is thrown if the
    NcType object is invalid. An NcNullDim exception is thrown if the NcDim
    object is invalid.
    \param    name     Variable name.
  ...
  */
  NcVar addVar(const std::string &name, const std::string &typeName,
  ...
  /*!
    ...
    \return             The NcVar object for this new netCDF variable.
  */
  NcVar addVar(const std::string &name, const NcType &ncType,
  ...
  */
  ...
  /*!
    ...
    The NcType and NcDim objects must be non-null, and be defined in either the
    current group or a parent group. An NcNullType exception is thrown if the
    NcType object is invalid. An NcNullDim exception is thrown if any of the the
    NcDim objects are invalid.
    \param    name        Variable name.
    \param    ncType      NcType object.
  ...
  */
  NcVar addVar(const std::string &name, const NcType &ncType,
               const std::vector<NcDim> &ncDimVector) const;
  ...
  */
  ...
  /*!
    ...
    \param location Enumeration type controlling the groups to search.
    \return         A STL multimap object, containing pairs of <attribute name,
    NcGroupAtt object> entities.
  */
  std::multimap<std::string, NcGroupAtt>
  getAtts(NcGroup::Location location = Current) const;
  ...
  */
  std::set<NcGroupAtt> getAtts(const std::string &name,
                               NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    \param name     Name of attribute
    \param location Enumeration type controlling the groups to search.
    \return         A NcGroupAtt object. If there are multiple objects indentied
    with the same name, the object closest  to the current group is returned. If
    no valid object is found , a \ref NcGroupAtt::isNull "null node" is
    returned.
  */
  NcGroupAtt getAtt(const std::string &name,
                    NcGroup::Location location = Current) const;

  /*! \overload
   */
  NcGroupAtt putAtt(const std::string &name, size_t len,
                    const char **dataValues) const;

  /*! \overload
   */
  NcGroupAtt putAtt(const std::string &name,
                    const std::string &dataValues) const;
  /*! \overload
   */
  NcGroupAtt putAtt(const std::string &name, const NcType &type,
  ...
  /*! \overload
   */
  NcGroupAtt putAtt(const std::string &name, const NcType &type, size_t len,
  ...
  */
  ...
  /*!
    ...
    \param location Enumeration type controlling the groups to search.
    \return         A STL multimap object, containing pairs of <attribute name,
    NcDim object> entities.
  */
  std::multimap<std::string, NcDim>
  getDims(NcGroup::Location location = Current) const;
  ...
  */
  std::set<NcDim> getDims(const std::string &name,
                          NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    \param name       Name of dimension.
    \param location   Enumeration type controlling the groups to search.
    \return           An NcDim object. If there are multiple objects indentied
    with the same name, the object closest to the current group is returned. If
    no valid object is found , a \ref NcDim::isNull "null node" is returned.
  */
  NcDim getDim(const std::string &name,
               NcGroup::Location location = Current) const;

  /*!
    Adds a new netCDF dimension.
    \param The name of new dimension.
    \param Length of dimension; that is, number of values for this dimension as
    an index to variables that use it.
  ...
  */
  int getTypeCount(NcType::ncType enumType,
                   NcGroup::Location location = Current) const;

  /*!
    Gets the collection of NcType objects.
    \param location Enumeration type controlling the groups to search.
    \return         A STL multimap object, on return contains pairs of <Type
    name, NcType object> entities. For atomic types, the type returned is the
    CDL name.
  */
  std::multimap<std::string, NcType>
  getTypes(NcGroup::Location location = Current) const;

  /*!
    Gets the collection of NcType objects with a given name.
    \param name     Name of type. For atomic types, the CDL name is expected.
    This is consistent with the string returned from NcType::getName().
    \param location Enumeration type controlling the groups to search.
    \return         Set of  NcType objects.
  */
  std::set<NcType> getTypes(const std::string &name,
                            NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    \return         Set of Nctype objects.
  */
  std::set<NcType> getTypes(NcType::ncType enumType,
                            NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    \return         Set of Nctype objects.
  */
  std::set<NcType> getTypes(const std::string &name, NcType::ncType enumType,
                            NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    This is consistent with the string returned from NcType::getName().
    \param location Enumeration type controlling the groups to search.
    \return         NcType object. If there are multiple objects indentied with
    the same name, the object closest to the current group is returned.  If no
    valid object is found , a \ref NcType::isNull "null node" is returned.

  */
  NcType getType(const std::string &name,
                 NcGroup::Location location = Current) const;
  ...
  */
  NcEnumType addEnumType(const std::string &name,
  ...
  */
  ...
  /*!
    ...
    \param name     Name of type.
    \param size     The size of the new type in bytes.
    \return         The new NcCompoundType object for this new netCDF
    userDefined type.
  */
  ...
  /*!
    ...
    Coordinate variable have  an NcDim and NcVar object with the same name
    defined in the same group.
    \par
    The method returns STL map object containing a coordinate variables in the
    current group  and optionally in the parent and child groups. It is expected
    that within each group, the names of dimensions are unique and the the names
    of variables are unique. However, if this is not the case, this method will
    still work correctly.

    \param location Enumeration type controlling the groups to search.
    \return         The NcVar dimension variable. If no valid object is found ,
    a \ref NcVar::isNull "null node" is returned.
  */
  std::map<std::string, NcGroup>
  getCoordVars(NcGroup::Location location = Current) const;
  ...
  /*!
    ...
    defined in the same group.
    \par
    The method returns two objects for the named coordinate variable. The method
    searches first in the current group and optionally in the parent and child
    group and returns the first instance found.
    \param location Enumeration type controlling the groups to search.
    \return         The set of names of dimension variables.
  */
  void getCoordVar(std::string &coordVarName, NcDim &ncDim, NcVar &ncVar,
                   NcGroup::Location location = Current) const;
