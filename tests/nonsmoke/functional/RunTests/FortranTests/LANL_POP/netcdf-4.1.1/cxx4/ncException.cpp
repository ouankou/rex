...
NcException::NcException(const string &name, const string &complaint,
                         const char *file, int line)
    : message(complaint), exceptionName(name), fileName(file), lnumber(line) {
...
NcInvalidWrite::NcInvalidWrite(const string &complaint, const char *file,
                               int line)
    : NcException("NcInvalidWrite", complaint, file, line) {}

// Thrown if operation not allowed in data mode.
NcNotInDefineMode::NcNotInDefineMode(const string &complaint, const char *file,
                                     int line)
    : NcException("NcNotIndDefineMode", complaint, file, line) {}

// Thrown if operation not allowed in defined mode.
NcInDefineMode::NcInDefineMode(const string &complaint, const char *file,
                               int line)
    : NcException("NcInDefineMode", complaint, file, line) {}

// Index exceeds dimension bound
NcInvalidCoords::NcInvalidCoords(const string &complaint, const char *file,
                                 int line)
...
NcUnknownName::NcUnknownName(const string &complaint, const char *file,
                             int line)
...
// Thrown if an operation to set the deflation, chunking, endianness, fill,
// compression, or checksum of a NcVar object is issued after a call to
// NcVar::getVar or NcVar::putVar.
