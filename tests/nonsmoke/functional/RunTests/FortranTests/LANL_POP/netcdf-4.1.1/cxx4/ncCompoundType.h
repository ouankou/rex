...
public:
  ...
  /*!
    Constructor.
    The compound Type must already exist in the netCDF file. New netCDF compound
    types can be added using NcGroup::addNcCompoundType();
  ...
  */
  ...
  /*!
    ...
    NcType is not the base of a Compound type.
  ...
  */
  ...
  /*!
    ...
    the NcType is not the base of a Compound type.
  */
  ...
  /*!
    ...
    \param offset        Offset of this member in bytes, obtained by a call to
offsetof. For example the offset of a member "mem4" in structure struct1 is:
offsetof(struct1,mem4).
  */
  void addMember(const std::string &memName, const NcType &newMemberType,
                 size_t offset);
  ...
  */
  void addMember(const std::string &memName, const NcType &newMemberType,
                 size_t offset, const std::vector<int> &shape);
  ...
  /*!
    ...
    \return The number of dimensions of the field. Non-array fields have 0
    dimensions.
  */
  ...
  /*!
    ...
    \param Index of member (numbering starts at zero).
    \return The size of the dimensions of the field. Non-array fields have 0
    dimensions.
  */
