...
int main() {
  try {
    ...
    // put variables of different type into the same variable type: requires
    // conversion.
    var_1.putVar(&a1[0]);
    var_2.putVar(&a2[0]);
    var_3.putVar(&a3[0]);
    ...
    int deflateLevel;
    var_2.getCompressionParameters(shuffleFilterEnabled, deflateFilterEnabled,
                                   deflateLevel);
    cout << "fill parameter =" << bFill2 << endl;
    cout << "checksum  =" << aa << endl;
    cout << "chunking parameters: chunk mode=" << cc1
         << "    Chunk sizes=" << cc2[0] << endl;
    ...
    cout << "varAtt variable name =" << attA7_1.getParentVar().getName()
         << endl;
    ...
    /*
      if(a1 != b1)  throw NcException("NcException","Error in
      test 1.1",__FILE__,__LINE__); if(a2 != b2)  throw
      NcException("NcException","Error in test 1.2",__FILE__,__LINE__); if(a3 !=
      b3)  throw NcException("NcException","Error in
      test 1.3",__FILE__,__LINE__); if(a4 != b4)  throw
      NcException("NcException","Error in test 1.4",__FILE__,__LINE__); if(a5 !=
      b5)  throw NcException("NcException","Error in
      test 1.5",__FILE__,__LINE__); if(a6 != b6)  throw
      NcException("NcException","Error in test 1.6",__FILE__,__LINE__); if(a7 !=
      b7)  throw NcException("NcException","Error in
      test 1.7",__FILE__,__LINE__); if(a8 != b8)  throw
      NcException("NcException","Error in test 1.8",__FILE__,__LINE__); if(a9 !=
      b9)  throw NcException("NcException","Error in
      test 1.9",__FILE__,__LINE__);
    */

    //   check writing out too much or too little data!!!!
    // put in documentation that for the put() and get() you must be sure that
    // // you get the variables correctly sized
    //   implement....
