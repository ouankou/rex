...
public:
  ...
  /*!
    Constructor.
    The vlen Type must already exist in the netCDF file. New netCDF vlen types
    can be added using NcGroup::addNcVlenType();
  ...
  */
  ...
  /*!
    ...
    NcType is not the base of a Vlen type.
  ...
  */
  ...
  /*!
    ...
    the NcType is not the base of a Vlen type.
  */
