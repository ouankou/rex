...
public:
  /*!
    ...
    The enumeration list contains the complete set of netCDF variable types. In
    addition, the type NC_TYPE is included. This enables the user to instantiate
    a netCDF type object without explcitly needing to know it precise type.
  */
  enum ncType {
  ...
  /*!
    ...
    This object describes the "essential" information for all netCDF types
    required by NcVar, NcAtt objects. New netCDF types can be added using the
    appropriate "add" method in the NcGroup object.
  ...
  */
  ...
  /*!
    The name of this type. For atomic types, the CDL type names are returned.
  ...
  /*!
    The size in bytes.
    This function will work on any type, including atomic and any user defined
  ...
  /*!
    ...
    Valid for all types, whether atomic or user-defined. User-defined types are
    returned as one of the following enumeration types: nc_VLEN, nc_OPAQUE,
    nc_ENUM, or nc_COMPOUND.
   */
  ncType getTypeClass() const;

  /*!
    Return a string containing the name of the enumerated type.  (ie one of the
    following strings: "nc_BYTE", "nc_CHAR", "nc_SHORT", "nc_INT", "nc_FLOAT",
