...
NcAtt::NcAtt() : nullObject(true) {}

// Constructor for non-null instances.
NcAtt::NcAtt(bool nullObject) : nullObject(nullObject) {}

// The copy constructor.
NcAtt::NcAtt(const NcAtt &rhs)
    : nullObject(rhs.nullObject), myName(rhs.myName), groupId(rhs.groupId),
      varId(rhs.varId) {}
...
//  !=  operator
bool NcAtt::operator!=(const NcAtt &rhs) const { return !(*this == rhs); }
...
NcType NcAtt::getType() const {
  ...
  nc_type xtypep;
  ncCheck(nc_inq_atttype(groupId, varId, myName.c_str(), &xtypep), __FILE__,
          __LINE__);
  if (xtypep <= 12)
  ...
  // this is a user-defined type
  {
    ...
    multimap<string, NcType> typeMap(
        getParentGroup().getTypes(NcGroup::ParentsAndCurrent));
...
size_t NcAtt::getAttLength() const {
  size_t lenp;
  ncCheck(nc_inq_attlen(groupId, varId, myName.c_str(), &lenp), __FILE__,
          __LINE__);
  return lenp;
}
...
void NcAtt::getValues(string &dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att(groupId, varId, myName.c_str(), tmpValues), __FILE__,
            __LINE__);
  else
    ncCheck(nc_get_att_text(groupId, varId, myName.c_str(), tmpValues),
            __FILE__, __LINE__);
...
void NcAtt::getValues(char *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
      typeClass == NcType::nc_ENUM | typeClass == NcType::nc_COMPOUND)
    ncCheck(nc_get_att(groupId, varId, myName.c_str(), dataValues), __FILE__,
            __LINE__);
  else
    ncCheck(nc_get_att_text(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(unsigned char *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_uchar(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(signed char *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_schar(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(short *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_short(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(int *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_int(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(long *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_long(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(float *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_float(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(double *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_double(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(unsigned short *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_ushort(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(unsigned int *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_uint(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(long long *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_longlong(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(unsigned long long *dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_ulonglong(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
...
void NcAtt::getValues(char **dataValues) const {
  ...
  if (typeClass == NcType::nc_VLEN | typeClass == NcType::nc_OPAQUE |
    ...
    ncCheck(nc_get_att_string(groupId, varId, myName.c_str(), dataValues),
            __FILE__, __LINE__);
}
