...
#define PCINT2FINT_cfSTR(N, T, A, B, C, D, E)                                  \
...
#define PCNDX2FNDX_cfSTR(N, T, A, B, C, D, E)                                  \
...
#define PDIMIDS_cfSTR(N, T, A, B, C, D, E)                                     \
...
#define CHUNKSIZES_cfSTR(N, T, A, B, C, D, E)                                  \
...
#define PCHUNKSIZES_cfSTR(N, T, A, B, C, D, E)                                 \
...
#define STRIDES_cfSTR(N, T, A, B, C, D, E)                                     \
