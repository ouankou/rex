 ...
 */
extern NF_INTEGER *c2f_dimids(int ncid,             /* netCDF dataset ID */
 ...
 */
extern int *f2c_dimids(int ndims,                 /* number of dims  */
 ...
 */
extern size_t *f2c_coords(int ncid,                  /* dataset ID */
 ...
 *	    RESULT == <ccounts>.
 */
extern size_t *f2c_counts(int ncid,                  /* dataset ID */
                          int varid,                 /* variable ID */
 ...
 */
extern ptrdiff_t *f2c_strides(int ncid,                   /* dataset ID */
                              int varid,                  /* variable ID */
 ...
 *	    RESULT == <cmaps>.
 */
extern ptrdiff_t *f2c_maps(int ncid,                /* dataset ID */
                           int varid,               /* variable ID */
