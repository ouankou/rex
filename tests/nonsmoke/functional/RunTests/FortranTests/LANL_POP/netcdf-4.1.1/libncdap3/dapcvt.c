 ...
 *   $Header: /shared/CVS/netcdf-3/libncdap3/dapcvt.c,v 1.14 2009/11/29 00:16:26
 *dmh Exp $
 *********************************************************************/
#include "config.h"
...
NCerror dapconvert3(nc_type srctype, nc_type dsttype, char *memory0,
                    char *value0, size_t count) {
...
#define ARM(vs, ncs, ts, vd, ncd, td)                                          \
  ...
  for (i = 0; i < count; i++) {
    ...
    switch (CASE(srctype, dsttype)) {
      ...
      ARM(ncubyte, NC_UBYTE, unsigned char, ncuint64, NC_UINT64,
          unsigned long long)
      ...
      ARM(ncushort, NC_USHORT, unsigned short, ncushort, NC_USHORT,
          unsigned short)
      ...
      ARM(ncushort, NC_USHORT, unsigned short, ncuint64, NC_UINT64,
          unsigned long long)
      ...
      ARM(ncuint, NC_UINT, unsigned int, ncuint64, NC_UINT64,
          unsigned long long)
      ...
      ARM(ncuint64, NC_UINT64, unsigned long long, ncubyte, NC_UBYTE,
          unsigned char)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncshort, NC_SHORT, short)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncushort, NC_USHORT,
          unsigned short)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncint, NC_INT, int)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncuint, NC_UINT,
          unsigned int)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncint64, NC_INT64, long long)
      ARM(ncuint64, NC_UINT64, unsigned long long, ncuint64, NC_UINT64,
          unsigned long long)
...
NCerror dapcvtattrval3(nc_type etype, void *dst, NClist *src) {
  int i, ok;
  NCerror ncstat = NC_NOERR;
