 ...
 */
static NC_attr *new_NC_attr(const char *uname, nc_type type, size_t nelems) {
  NC_string *strp;
  NC_attr *attrp;
 ...
 */
NC_attr **NC_findattr(const NC_attrarray *ncap, const char *uname) {
  NC_attr **attrpp;
  size_t attrid;
  size_t slen;
  char *name;
...
int DISPNAME(inq_attname)(int ncid, int varid, int attnum, char *name) {
  int status;
  NC *ncp;
  NC_attrarray *ncap;
  NC_attr *attrp;
...
int DISPNAME(inq_attid)(int ncid, int varid, const char *name, int *attnump) {
  int status;
  NC *ncp;
  NC_attrarray *ncap;
  NC_attr **attrpp;
...
int DISPNAME(inq_att)(int ncid, int varid,
...
int DISPNAME(rename_att)(int ncid, int varid, const char *name,
                         const char *unewname) {
  int status;
  NC *ncp;
  NC_attrarray *ncap;
...
int DISPNAME(del_att)(int ncid, int varid, const char *uname) {
  int status;
  NC *ncp;
  NC_attrarray *ncap;
  NC_attr **attrpp;
