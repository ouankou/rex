 ...
 */
static NC_dim *new_NC_dim(const char *uname, size_t size) {
  NC_string *strp;
  NC_dim *dimp;
 ...
 * we moved a clearer 'break' inside the loop body to the loop test.
 */
static int NC_finddim(const NC_dimarray *ncap, const char *uname,
                      NC_dim **dimpp) {
...
int DISPNAME(def_dim)(int ncid, const char *name, size_t size, int *dimidp) {
  int status;
  NC *ncp;
  int dimid;
  NC_dim *dimp;
...
int DISPNAME(inq_dimid)(int ncid, const char *name, int *dimid_ptr) {
  int status;
  NC *ncp;
  int dimid;
...
int DISPNAME(rename_dim)(int ncid, int dimid, const char *unewname) {
  int status;
  NC *ncp;
  int existid;
  NC_dim *dimp;
