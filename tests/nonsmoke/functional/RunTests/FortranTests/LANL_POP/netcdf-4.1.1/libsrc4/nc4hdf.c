...
int 
RENAME4(nc4_put_vara)(NC_FILE_INFO_T *nc, int ncid, int varid, const size_t *startp, 
...
int 
RENAME4(nc4_get_vara)(NC_FILE_INFO_T *nc, int ncid, int varid, const size_t *startp, 
		      const size_t *countp, nc_type mem_nc_type, int is_long, void *data)
{
   NC_GRP_INFO_T *grp, *g;
   NC_HDF5_FILE_INFO_T *h5;
