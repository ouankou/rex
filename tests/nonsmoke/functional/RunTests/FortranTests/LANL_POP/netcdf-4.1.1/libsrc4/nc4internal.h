...
int nc4_pg_varm(NC_PG_T pg, NC_FILE_INFO_T *nc, int ncid, int varid,
                ...
                const ptrdiff_t *stridep, const ptrdiff_t *imapp, nc_type xtype,
                int is_long, void *op);
...
/*int nc_put_vlen_element(int ncid, int typeid, void *vlen_element, size_t len,
  const void *data); int nc_get_vlen_element(int ncid, int typeid, const void
  *vlen_element, size_t *len, void *data);*/
