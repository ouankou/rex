...
char *usage[] = {"",
                 " make_solo_mosaic --num_tiles ntiles --dir directory "
                 "[--mosaic_name mosaic_name] ",
                 "                 [--tile_file tile_file] [--periodx #] "
                 "[--periody #]             ",
                 "                                                             "
                 "                    ",
                 "make_solo_mosaic generates Mosaic information between tiles. "
                 "The mosaic          ",
                 "information includes: list of tile files, list of contact "
                 "region                 ",
                 ...
                 "                                                             "
                 "                    ",
                 "--dir directory        The directory that contains all the "
                 "tile grid file.       ",
                 "                                                             "
                 "                    ",
                 "OPTIONAL FLAGS                                               "
                 ...
                 "                                                             "
                 "                    ",
                 "--mosaic_name name     mosaic name. The output file will be "
                 "mosaic_name.nc.      ",
                 "                       default is 'mosaic'.                  "
                 "                    ",
                 "                                                             "
                 "                    ",
                 "--tile_file tile_file  Grid file name of all tiles in the "
                 "mosaic. The file name  ",
                 "                       should be relative file name ( "
                 "exclude the absolute       "
                 "                       file path). The absolute file path "
                 "will be dir/tile_file. ",
                 ...
                 "                                                             "
                 "                    ",
                 "--periodx #             Specify the period in x-direction of "
                 "mosaic. Default     ",
                 "                        value is 0 (not periodic).           "
                 "                    ",
                 "                                                             "
                 "                    ",
                 "--periody #             Specify the period in y-direction of "
                 "mosaic. Default     ",
                 "                        value is 0 (not periodic).           "
                 "                    ",
                 NULL};
...
main(int argc, char *argv[]) {
  ...
  if (mpp_npes() > 1)
    mpp_error("make_solo_mosaic: this tool must be run on one processor");
