...
char *usage[] = {"",
                 ...
                 "                                                             "
                 "                    ",
                 "   NOTE: This program call be used to make vertical grid for "
                 "FMS model.          ",
                 "         It uses cubic-spline algorithm to calculate the "
                 "grid cell location.     ",
                 "         The output netcdf will contains information on "
                 "supergrid with grid      ",
                 "         size equal model grid size multipling refinement ( "
                 "always 2 ).          ",
                 ...
                 "                                                             "
                 "                    ",
                 "   --nbnds nbnds             Specify number of vertical "
                 "regions for varying      ",
                 "                             resolution.                     "
                 "                    ",
                 "                                                             "
                 "                    ",
                 "   --bnds z(1),.,z(nbnds)    Specify boundaries for defining "
                 "vertical regions of ",
                 "                             varying resolution.             "
                 "                    ",
                 "                                                             "
                 "                    ",
                 "   --nz nz(1),..,nz(nbnds-1) Number of model grid points for "
                 "each vertical       ",
                 ...
                 "                                                             "
                 "                    ",
                 " --grid_name gridname        Specify the grid name. The "
                 "output grid file name    ",
                 "                             will be grid_name.nc. The "
                 "default value is          ",
                 "                             vertical_grid.                  "
                 "                    ",
                 "                                                             "
                 ...
                 "                   ",
                 "       will make a grid file with 60 supergrid cells, 30 "
                 "model grid cells        ",
