...
static enum XML_Error addBinding(XML_Parser parser, PREFIX *prefix,
  ...
  if (prefix->name && prefix->name[0] == XML_T('x') &&
      prefix->name[1] == XML_T('m') && prefix->name[2] == XML_T('l')) {

    /* Not allowed to bind xmlns */
    if (prefix->name[3] == XML_T('n') && prefix->name[4] == XML_T('s') &&
...
static enum XML_Error doProlog(XML_Parser parser, const ENCODING *enc,
  ...
  static const XML_Char atypeENTITIES[] = {'E', 'N', 'T', 'I', 'T',
                                           'I', 'E', 'S', '\0'};
  static const XML_Char atypeNMTOKEN[] = {'N', 'M', 'T', 'O',
                                          'K', 'E', 'N', '\0'};
  static const XML_Char atypeNMTOKENS[] = {'N', 'M', 'T', 'O', 'K',
                                           'E', 'N', 'S', '\0'};
  static const XML_Char notationPrefix[] = {'N', 'O', 'T', 'A', 'T',
                                            'I', 'O', 'N', '(', '\0'};
...
static ATTRIBUTE_ID *getAttributeId(XML_Parser parser, const ENCODING *enc,
  ...
  if (id->name != name)
    ...
    if (!ns)
      ;
    else if (name[0] == XML_T('x') && name[1] == XML_T('m') &&
             name[2] == XML_T('l') && name[3] == XML_T('n') &&
             name[4] == XML_T('s') &&
