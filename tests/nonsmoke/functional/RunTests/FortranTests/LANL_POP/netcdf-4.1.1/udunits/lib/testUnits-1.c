...
static int setup(void) { return utInit("/foo/bar"); }
...
static void test_utIsInit(void) { CU_ASSERT_TRUE(utIsInit()); }

static void test_utScan(void) {
  utUnit unit;
...
static void test_utCalendar(void) {
  utUnit unit;
...
static void test_utInvCalendar(void) {
  utUnit unit;
  double value;
...
static void test_utIsTime(void) {
  utUnit unit;
...
static void test_utHasOrigin(void) {
  utUnit unit;
...
static void test_utMultiply(void) {
...
static void test_utDivide(void) {
  utUnit m, s, result, expect;
  double slope, intercept;
...
static void test_utInvert(void) {
