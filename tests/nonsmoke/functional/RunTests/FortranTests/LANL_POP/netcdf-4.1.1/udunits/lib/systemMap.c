 ...
 */
void **smFind(const SystemMap *const map, const void *const system) {
  Entry targetEntry;
  Entry **treeEntry;
  ...
  return treeEntry == NULL ? NULL : &(*treeEntry)->ptr;
}
 ...
 *	else	Address of the pointer to which "system" maps.
 */
void **smSearch(SystemMap *const map, const void *system) {
 ...
 *	system	Pointer to the unit-system.
 */
void smRemove(SystemMap *const map, const void *const system) {
  Entry targetEntry;
  Entry **treeEntry;
 ...
 */
void smFree(SystemMap *const map) {
  if (map != NULL) {
    while (map->tree != NULL) {
