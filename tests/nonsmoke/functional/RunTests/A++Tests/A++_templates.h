...
#if 1
  // Bugs in the legacy compiler have routinely caused the base class member
...
public:
     ...
     // the different types of data (pointers of different types).
        Array_Descriptor_Type<T,MAX_ARRAY_DIMENSION> Array_Descriptor;
   };
...
friend class intArray_Aggregate_Operator;
     ...
     // Access function for Descriptor (if we make this return a const & then we can only call const member functions using it)
        inline const Array_Descriptor_Type<double,MAX_ARRAY_DIMENSION> & getDescriptor () const
             { return Array_Descriptor; };

     // Access function for Descriptor
        inline const Array_Descriptor_Type<double,MAX_ARRAY_DIMENSION>* getDescriptorPointer () const
             { return &Array_Descriptor; };
     ...
     // Access functions for serial data
        SerialArray_Descriptor_Type<double,MAX_ARRAY_DIMENSION> &
...
// elif defined(APP)
     ...
     // so we need to implement a redim that takes a single Index object.
        ...
        // The legacy compiler can't handle template declarations in non
	...
	void fix_view_bases_non_short_span 
     ...
     // This function is called in lazy_operand.C!
        doubleArray ( const doubleSerialArray* SerialArray_Pointer , 
        	    Array_Descriptor_Type<double,MAX_ARRAY_DIMENSION>* 
...
friend class intArray_Aggregate_Operator;
     ...
     // Access function for Descriptor (if we make this return a const & then we can only call const member functions using it)
        inline const Array_Descriptor_Type<float,MAX_ARRAY_DIMENSION> & getDescriptor () const
             { return Array_Descriptor; };

     // Access function for Descriptor
        inline const Array_Descriptor_Type<float,MAX_ARRAY_DIMENSION>* getDescriptorPointer () const
             { return &Array_Descriptor; };
...
#if defined(PPP)
     // Access functions for serial data
        SerialArray_Descriptor_Type<float,MAX_ARRAY_DIMENSION> &
	   getSerialArrayDescriptor() const
	      { return Array_Descriptor.SerialArray->Array_Descriptor; };
	...
	void fix_view_bases_non_short_span 
     ...
     // This function is called in lazy_operand.C!
        floatArray ( const floatSerialArray* SerialArray_Pointer , 
        	    Array_Descriptor_Type<float,MAX_ARRAY_DIMENSION>* 
		    Array_Descriptor_Pointer ,
        	    /*Array_Descriptor_Type* Array_Descriptor_Pointer ,*/
                    Operand_Storage* Array_Storage_Pointer );
#endif
...
friend class intArray_Aggregate_Operator;
     ...
     // Access function for Descriptor (if we make this return a const & then we can only call const member functions using it)
        inline const Array_Descriptor_Type<int,MAX_ARRAY_DIMENSION> & getDescriptor () const
             { return Array_Descriptor; };

     // Access function for Descriptor
        inline const Array_Descriptor_Type<int,MAX_ARRAY_DIMENSION>* getDescriptorPointer () const
             { return &Array_Descriptor; };
...
#if defined(PPP)
     // Access functions for serial data
        SerialArray_Descriptor_Type<int,MAX_ARRAY_DIMENSION> &
	   getSerialArrayDescriptor() const
	      { return Array_Descriptor.SerialArray->Array_Descriptor; };
	...
	void fix_view_bases_non_short_span 
     ...
     // This function is called in lazy_operand.C!
        intArray ( const intSerialArray* SerialArray_Pointer , 
        	    Array_Descriptor_Type<int,MAX_ARRAY_DIMENSION>* 
		    Array_Descriptor_Pointer ,
        	    /*Array_Descriptor_Type* Array_Descriptor_Pointer ,*/
                    Operand_Storage* Array_Storage_Pointer );
#endif
