...
int main(int argc, char *argv[]) {
  ...
  sss.push_back("0x2b9aaaf5c010<SgBasicBlock> @line=1 :idx=0");
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=0");
  ...
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=1");
  ...
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=2");
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=4");
  sss.push_back("0x2b9aaaf5c010<SgBasicBlock> @line=1 :idx=1");
  sss.push_back("SgReturnStmt<SgReturnStmt> @line=4 :idx=0");
  sss.push_back("integer_value_exp_0<SgIntVal> @line=4 :idx=0");
  sss.push_back("integer_value_exp_0<SgIntVal> @line=4 :idx=1");
  sss.push_back("SgReturnStmt<SgReturnStmt> @line=4 :idx=1");
  ...
  sss.push_back("SgExprStatement<SgExprStatement> @line=2 :idx=1");
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=2");
  sss.push_back("0x2b9aaaf5c188<SgBasicBlock> @line=2 :idx=0");
  sss.push_back("0x2b9aaafb8010<SgForStatement> @line=2 :idx=3");
