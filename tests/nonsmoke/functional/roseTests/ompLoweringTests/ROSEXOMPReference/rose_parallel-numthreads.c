...
int main(int argc, char **argv) {
  ...
  int i = 0;
  XOMP_parallel_start(
      OUT__2__10915__, 0, i == 0, 3,
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/parallel-numthreads.c",
      9);
  XOMP_parallel_end(
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/parallel-numthreads.c",
  ...
  if (XOMP_single()) {
    (((void)(sizeof(((omp_get_num_threads() == 1 ? 1 : 0))))), (({
       if (omp_get_num_threads() == 1)
         ...
         __assert_fail("omp_get_num_threads() == 1", "parallel-numthreads.c",
  ...
  if (XOMP_single()) {
    (((void)(sizeof(((omp_get_num_threads() == 3 ? 1 : 0))))), (({
       if (omp_get_num_threads() == 3)
         ...
         __assert_fail("omp_get_num_threads() == 3", "parallel-numthreads.c",
