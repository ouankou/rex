...
char **argv;
{
  ...
  XOMP_parallel_start(
      OUT__1__10698__, &__out_argv1__10698__, 1, 0,
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/reduction-classic.c",
      19);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                    "functional/CompileTests/OpenMP_tests/reduction-classic.c",
                    22);
  ...
  (((void)(sizeof(((sum == 5050 ? 1 : 0))))), (({
     if (sum == 5050)
       ...
       __assert_fail("sum==5050", "reduction-classic.c", 24,
                     __PRETTY_FUNCTION__);
   })));
