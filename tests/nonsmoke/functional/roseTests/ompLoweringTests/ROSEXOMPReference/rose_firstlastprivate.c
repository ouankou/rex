...
char **argv;
{
  ...
  XOMP_parallel_start(OUT__1__10693__, &__out_argv1__10693__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/firstlastprivate.c",
                      12);
...
static void OUT__1__10693__(void *__out_argv) {
  ...
  int *num_steps =
      (int *)(((struct OUT__1__10693___data *)__out_argv)->num_steps_p);
  int _p_i;
  int _p_sum = *sum;
  long p_index_;
  long p_lower_;
