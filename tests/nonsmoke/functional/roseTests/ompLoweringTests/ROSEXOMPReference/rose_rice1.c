 ...
 *  Outliner will have trouble to generate a legal array type based on the
 * variable within the outlined function
 *
 ...
 *  int (*a)[N] = (int (*)[N])(((struct OUT__1__1527___data *)__out_argv) ->
 * a_p);
 *
 *  A possible fix is to run constant propagation first before OpenMP
 * translation.a Or adjust N to be *N: the variable substitution for shared
 * variable did not work on the type node, which might be ignored by AST
 * traversal by default. Or the entire declaration statement is not searched at
 * all!!
 *
 * 1/12/2009
 * */
...
int main(int argc, char *argv[]) {
  ...
  XOMP_parallel_start(OUT__2__9410__, &__out_argv2__9410__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/rice1.c",
                      25);
  ...
  XOMP_parallel_start(OUT__1__9410__, &__out_argv1__9410__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/rice1.c",
                      39);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
...
static void OUT__1__9410__(void *__out_argv) {
  int (*a)[100000] =
      (int (*)[100000])(((struct OUT__1__9410___data *)__out_argv)->a_p);
  int _p_i;
  long p_index_;
  long p_lower_;
  long p_upper_;
...
static void OUT__2__9410__(void *__out_argv) {
  int *nthreads =
      (int *)(((struct OUT__2__9410___data *)__out_argv)->nthreads_p);
  int _p_th_id;
