...
char **argv;
{
  ...
  XOMP_parallel_start(OUT__1__9863__, &__out_argv1__9863__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/sections1.c",
                      6);
...
static void OUT__1__9863__(void *__out_argv) {
  int *section_count =
      (int *)(((struct OUT__1__9863___data *)__out_argv)->section_count_p);
