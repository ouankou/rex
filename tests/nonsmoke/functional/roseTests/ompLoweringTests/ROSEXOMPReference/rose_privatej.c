...
char **argv;
{
  ...
  XOMP_parallel_start(OUT__1__9811__, &__out_argv1__9811__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/privatej.c",
                      15);
...
static void OUT__1__9811__(void *__out_argv) {
  int (*a)[1000][1000] =
      (int (*)[1000][1000])(((struct OUT__1__9811___data *)__out_argv)->a_p);
  int _p_i;
  int _p_j;
  long p_index_;
  long p_lower_;
