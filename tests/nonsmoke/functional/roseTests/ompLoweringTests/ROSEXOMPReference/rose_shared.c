...
/*   figure out number of threads used */
  ...
  XOMP_parallel_start(OUT__1__9573__, &__out_argv1__9573__, 1, 6,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/shared.c",
                      21);
...
static void OUT__1__9573__(void *__out_argv) {
  int *num_threads =
      (int *)(((struct OUT__1__9573___data *)__out_argv)->num_threads_p);
