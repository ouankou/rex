...
4/14/2010
*/
#include <omp.h> // The non-existence of omp.h is essential to repeat the original bug
#include <stdio.h>
// #include <omp.h>
...
char **argv;
{
  ...
  XOMP_parallel_start(OUT__1__10581__, &__out_argv1__10581__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/ompGetNumThreads.c",
                      16);
