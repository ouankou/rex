...
char **argv;
{
  ...
  XOMP_parallel_start(OUT__1__10213__, &__out_argv1__10213__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/falsesharing.c",
                      16);
...
static void OUT__1__10213__(void *__out_argv) {
  ...
  double (*sum)[2] =
      (double (*)[2])(((struct OUT__1__10213___data *)__out_argv)->sum_p);
