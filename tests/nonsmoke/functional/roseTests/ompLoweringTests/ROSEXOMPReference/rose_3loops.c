...
/*  Other loops are not affected by omp directive, so their index variables are
 * still shared! Affected ==> collapse(n) or ordered (n)
 */
...
int main(int argc, char **argv) {
  ...
  XOMP_parallel_start(OUT__1__9550__, &__out_argv1__9550__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/3loops.c",
                      14);
...
static void OUT__1__9550__(void *__out_argv) {
  double (*a)[10][9][8] =
      (double (*)[10][9][8])(((struct OUT__1__9550___data *)__out_argv)->a_p);
  int _p_i;
  int _p_jj;
  int _p_kkk;
  long p_index_;
