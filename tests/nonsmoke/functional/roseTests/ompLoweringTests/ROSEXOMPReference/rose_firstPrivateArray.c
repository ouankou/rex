  ...
  for (i = 0; i < 100; i++)
    (((void)(sizeof(((array[i] == 10 ? 1 : 0))))), (({
       if (array[i] == 10)
         ...
         __assert_fail("array[i]==10", "firstPrivateArray.c", 34,
                       __PRETTY_FUNCTION__);
     })));
