...
int main(int argc, char **argv) {
  ...
  XOMP_init(argc, argv);
  int i = 0;
  XOMP_parallel_start(OUT__2__10039__, 0, i == 0, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/parallel-if.c",
                      10);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                    "functional/CompileTests/OpenMP_tests/parallel-if.c",
                    13);
  XOMP_parallel_start(OUT__1__10039__, 0, i != 0, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/parallel-if.c",
                      15);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
  ...
  if (XOMP_single()) {
    (((void)(sizeof(((omp_get_num_threads() == 1 ? 1 : 0))))), (({
       if (omp_get_num_threads() == 1)
         ...
         __assert_fail("omp_get_num_threads() == 1", "parallel-if.c", 19,
                       __PRETTY_FUNCTION__);
     })));
  }
  XOMP_barrier();
