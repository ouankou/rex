...
int main(int argc, char **argv) {
...
#endif
  XOMP_parallel_start(OUT__1__10547__, &__out_argv1__10547__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/set_num_threads.c",
                      13);
  ...
  (((void)(sizeof(((counter == 7 ? 1 : 0))))), (({
     if (counter == 7)
       ...
       __assert_fail("counter == 7", "set_num_threads.c", 21,
                     __PRETTY_FUNCTION__);
   })));
#else
#endif
...
static void OUT__1__10547__(void *__out_argv) {
  int *counter =
      (int *)(((struct OUT__1__10547___data *)__out_argv)->counter_p);
  int *nthreads =
      (int *)(((struct OUT__1__10547___data *)__out_argv)->nthreads_p);
