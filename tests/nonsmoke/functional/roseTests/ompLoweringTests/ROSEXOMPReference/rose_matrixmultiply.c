...
int mmm() {
  ...
  __out_argv1__10499__.__final_total_iters__2___p =
      ((void *)(&__final_total_iters__2__));
  XOMP_parallel_start(OUT__1__10499__, &__out_argv1__10499__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/matrixmultiply.c",
                      60);
...
int verify() {
  ...
  (((void)(sizeof(((sum == sum2 ? 1 : 0))))), (({
     if (sum == sum2)
       ...
       __assert_fail("sum == sum2", "matrixmultiply.c", 91,
                     __PRETTY_FUNCTION__);
   })));
  return 0;
}
...
static void OUT__1__10499__(void *__out_argv) {
  int *__final_total_iters__2__ =
      (int *)(((struct OUT__1__10499___data *)__out_argv)
                  ->__final_total_iters__2___p);
  int *__i_interval__3__ =
      (int *)(((struct OUT__1__10499___data *)__out_argv)->__i_interval__3___p);
  int _p_i;
  int _p_j;
  int _p_k;
