...
int main(int argc, char **argv) {
  ...
  mits = 5000;
#ifdef _OPENMP
  XOMP_parallel_start(OUT__4__9558__, 0, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi.c",
                      77);
...
void initialize() {
  ...
  XOMP_parallel_start(OUT__3__9558__, 0, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi.c",
                      130);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
...
void jacobi() {
  ...
  while (k <= mits && error > tol) {
    ...
    XOMP_parallel_start(OUT__2__9558__, &__out_argv2__9558__, 1, 0,
                        "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                        "functional/CompileTests/OpenMP_tests/jacobi.c",
                        191);
    XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
  ...
  (((void)(sizeof(((fabs(error - resid_ref) / resid_ref < 1E-5 ? 1 : 0))))), (({
     if (fabs(error - resid_ref) / resid_ref < 1E-5)
       ...
       __assert_fail("fabs(error-resid_ref)/resid_ref < 1E-5", "jacobi.c", 225,
                     __PRETTY_FUNCTION__);
   })));
}
...
void error_check() {
  ...
  XOMP_parallel_start(OUT__1__9558__, &__out_argv1__9558__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi.c",
                      242);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
  ...
  (((void)(sizeof(((fabs(error - error_ref) / error_ref < 1E-5 ? 1 : 0))))), (({
     if (fabs(error - error_ref) / error_ref < 1E-5)
       ...
       __assert_fail("fabs(error-error_ref)/error_ref < 1E-5", "jacobi.c", 255,
                     __PRETTY_FUNCTION__);
   })));
}
...
static void OUT__1__9558__(void *__out_argv) {
  double *error =
      (double *)(((struct OUT__1__9558___data *)__out_argv)->error_p);
  int _p_i;
  int _p_j;
  double _p_xx;
  double _p_yy;
  ...
  for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
    for (_p_j = 0; _p_j < m; _p_j++) {
      ...
      _p_yy = -1.0 + dy * (_p_j - 1);
      _p_temp =
          u[p_index_][_p_j] - (1.0 - _p_xx * _p_xx) * (1.0 - _p_yy * _p_yy);
...
static void OUT__2__9558__(void *__out_argv) {
  double *omega =
      (double *)(((struct OUT__2__9558___data *)__out_argv)->omega_p);
  double *error =
      (double *)(((struct OUT__2__9558___data *)__out_argv)->error_p);
  ...
  }
  {
    ...
    for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
      for (_p_j = 1; _p_j < m - 1; _p_j++) {
        _p_resid =
            (*ax * (uold[p_index_ - 1][_p_j] + uold[p_index_ + 1][_p_j]) +
             *ay * (uold[p_index_][_p_j - 1] + uold[p_index_][_p_j + 1]) +
             *b * uold[p_index_][_p_j] - f[p_index_][_p_j]) /
            *b;
...
static void OUT__3__9558__(void *__out_argv) {
  ...
  for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
    for (_p_j = 0; _p_j < m; _p_j++) {
      ...
      u[p_index_][_p_j] = 0.0;
      f[p_index_][_p_j] =
          -1.0 * alpha * (1.0 - (_p_xx * _p_xx)) * (1.0 - (_p_yy * _p_yy)) -
          2.0 * (1.0 - (_p_xx * _p_xx)) - 2.0 * (1.0 - (_p_yy * _p_yy));
    }
  }
  XOMP_barrier();
}
