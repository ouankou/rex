...
int main(int argc, char **argv) {
  ...
  XOMP_parallel_start(
      OUT__2__10855__, &__out_argv2__10855__, 1, 0,
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/parallel-reduction2.c",
      9);
  XOMP_parallel_end(
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/parallel-reduction2.c",
  ...
  (((void)(sizeof(((sum == i * thread_num + 100 ? 1 : 0))))), (({
     if (sum == i * thread_num + 100)
       ...
       __assert_fail("sum == (i*thread_num + 100)", "parallel-reduction2.c", 18,
                     __PRETTY_FUNCTION__);
   })));
  sum = 100;
  ...
  XOMP_parallel_start(
      OUT__1__10855__, &__out_argv1__10855__, 1, 0,
      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
      "CompileTests/OpenMP_tests/parallel-reduction2.c",
      21);
  XOMP_parallel_end(
  ...
  (((void)(sizeof(((sum != i * thread_num + 100 ? 1 : 0))))), (({
     if (sum != i * thread_num + 100)
       ...
       __assert_fail("sum != (i*thread_num + 100)", "parallel-reduction2.c", 30,
                     __PRETTY_FUNCTION__);
   })));
...
static void OUT__1__10855__(void *__out_argv) {
  ...
  int *thread_num =
      (int *)(((struct OUT__1__10855___data *)__out_argv)->thread_num_p);
  int _p_sum;
  if (XOMP_single()) {
...
static void OUT__2__10855__(void *__out_argv) {
  ...
  int *thread_num =
      (int *)(((struct OUT__2__10855___data *)__out_argv)->thread_num_p);
  int _p_sum;
  _p_sum = 0;
  if (XOMP_single()) {
    *thread_num = omp_get_num_threads();
