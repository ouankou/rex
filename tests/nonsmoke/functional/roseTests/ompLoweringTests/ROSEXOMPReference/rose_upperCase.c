...
/*   figure out number of threads used */
  ...
  XOMP_parallel_start(OUT__1__9878__, &__out_argv1__9878__, 1, 6,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/upperCase.c",
                      18);
...
static void OUT__1__9878__(void *__out_argv) {
  int *NUM_THREADS =
      (int *)(((struct OUT__1__9878___data *)__out_argv)->NUM_THREADS_p);
  if (XOMP_master())
