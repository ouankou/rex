...
int main(int argc, char **argv) {
  ...
  XOMP_parallel_start(OUT__1__10164__, &__out_argv1__10164__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/parallelfor2.c",
                      6);
...
static void OUT__1__10164__(void *__out_argv) {
  int (*a)[1000] =
      (int (*)[1000])(((struct OUT__1__10164___data *)__out_argv)->a_p);
  int _p_i;
  long p_index_;
  long p_lower_;
  long p_upper_;
