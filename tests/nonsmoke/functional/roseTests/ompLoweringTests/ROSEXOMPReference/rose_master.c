...
void foo(int step, int niter) {
  ...
  XOMP_parallel_start(OUT__1__9594__, &__out_argv1__9594__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/master.c",
                      8);
...
static void OUT__1__9594__(void *__out_argv) {
  ...
  int *nthreads =
      (int *)(((struct OUT__1__9594___data *)__out_argv)->nthreads_p);
  int _p_step;
  int _p_niter = niter;
