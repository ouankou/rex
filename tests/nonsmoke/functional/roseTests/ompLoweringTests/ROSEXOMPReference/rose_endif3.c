...
int fib1(int n) {
  ...
  int fib2(int n) {
    ...
    XOMP_parallel_start(OUT__1__9511__, &__out_argv1__9511__, 1, 0,
                        "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                        "functional/CompileTests/OpenMP_tests/endif3.c",
                        43);
  ...
  static void OUT__1__9511__(void *__out_argv) {
    ...
    if (XOMP_single())
    // this bracket is essential  now, since we don't use wave by default to
    // decide the scope of #endif!!
    {
#if defined(MANUAL_CUTOFF) || defined(IF_CUTOFF)
#else
    par_res = fib2(*n);
