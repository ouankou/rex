...
char **argv;
{
  int status = 0;
  XOMP_init(argc, argv);
  XOMP_parallel_start(OUT__3__10172__, 0, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/task_untied3.c",
                      13);
...
static void OUT__2__10172__(void *__out_argv) {
  ...
  for (_p_i = 0; _p_i < 10; _p_i++) {
    ...
    XOMP_task(OUT__1__10172__, &__out_argv1__10172__, 0,
              sizeof(struct OUT__1__10172___data), 4, 1, 0);
  }
}
...
static void OUT__3__10172__(void *__out_argv) {
  if (XOMP_single()) {
    ...
    XOMP_task(OUT__2__10172__, &__out_argv2__10172__, 0,
              sizeof(struct OUT__2__10172___data), 4, 1, 1);
  }
  XOMP_barrier();
}
