...
int main(int argc, char **argv) {
  ...
  mits = 5000;
#ifdef _OPENMP
  XOMP_parallel_start(OUT__4__10454__, 0, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi-collapse.c",
                      80);
...
void initialize() {
  ...
  int yy;
  // double PI=3.1415926;
  int __i_total_iters__18__ =
      (n - 1 - 0 + 1) % 1 == 0 ? (n - 1 - 0 + 1) / 1 : (n - 1 - 0 + 1) / 1 + 1;
  int __j_total_iters__19__ =
      (m - 1 - 0 + 1) % 1 == 0 ? (m - 1 - 0 + 1) / 1 : (m - 1 - 0 + 1) / 1 + 1;
  int __final_total_iters__20__ =
      1 * __i_total_iters__18__ * __j_total_iters__19__;
  ...
  __out_argv3__10454__.__final_total_iters__20___p =
      ((void *)(&__final_total_iters__20__));
  /* Initialize initial condition and RHS */
  XOMP_parallel_start(OUT__3__10454__, &__out_argv3__10454__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi-collapse.c",
                      133);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
...
void jacobi() {
  ...
  while (k <= mits && error > tol) {
    ...
    XOMP_parallel_start(
        OUT__2__10454__, &__out_argv2__10454__, 1, 0,
        "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/functional/"
        "CompileTests/OpenMP_tests/jacobi-collapse.c",
        193);
    XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi-collapse.c",
                      211);
  ...
  (((void)(sizeof(((fabs((error - resid_ref)) / resid_ref < 1E-4 ? 1 : 0))))),
   (({
     if (fabs((error - resid_ref)) / resid_ref < 1E-4)
       ...
       __assert_fail("fabs(error-resid_ref)/resid_ref < 1E-4",
                     "jacobi-collapse.c", 227, __PRETTY_FUNCTION__);
   })));
}
...
void error_check() {
  ...
  float temp;
  float error;
  int __i_total_iters__0__ =
      (n - 1 - 0 + 1) % 1 == 0 ? (n - 1 - 0 + 1) / 1 : (n - 1 - 0 + 1) / 1 + 1;
  int __j_total_iters__1__ =
      (m - 1 - 0 + 1) % 1 == 0 ? (m - 1 - 0 + 1) / 1 : (m - 1 - 0 + 1) / 1 + 1;
  int __final_total_iters__2__ =
      1 * __i_total_iters__0__ * __j_total_iters__1__;
  ...
  __out_argv1__10454__.__final_total_iters__2___p =
      ((void *)(&__final_total_iters__2__));
  __out_argv1__10454__.error_p = ((void *)(&error));
  XOMP_parallel_start(OUT__1__10454__, &__out_argv1__10454__, 1, 0,
                      "/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
                      "functional/CompileTests/OpenMP_tests/jacobi-collapse.c",
                      246);
  XOMP_parallel_end("/home/awang15/Projects/rexdev/rex_src/tests/nonsmoke/"
  ...
  (((void)(sizeof(((fabs((error - error_ref)) / error_ref < 1E-4 ? 1 : 0))))),
   (({
     if (fabs((error - error_ref)) / error_ref < 1E-4)
       ...
       __assert_fail("fabs(error-error_ref)/error_ref < 1E-4",
                     "jacobi-collapse.c", 259, __PRETTY_FUNCTION__);
   })));
}

static void OUT__1__10454__(void *__out_argv) {
  float *error =
      (float *)(((struct OUT__1__10454___data *)__out_argv)->error_p);
  int *__final_total_iters__2__ =
      (int *)(((struct OUT__1__10454___data *)__out_argv)
                  ->__final_total_iters__2___p);
  int *__i_interval__3__ =
      (int *)(((struct OUT__1__10454___data *)__out_argv)->__i_interval__3___p);
  ...
  for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
    ...
    _p_temp = ((float)(((double)u[_p_i][_p_j]) -
                       (1.0 - ((double)(_p_xx * _p_xx))) *
                           (1.0 - ((double)(_p_yy * _p_yy)))));
...
static void OUT__2__10454__(void *__out_argv) {
  float *omega =
      (float *)(((struct OUT__2__10454___data *)__out_argv)->omega_p);
  float *error =
      (float *)(((struct OUT__2__10454___data *)__out_argv)->error_p);
  ...
  int __i_total_iters__6__ = (n - 1 - 1 - 1 + 1) % 1 == 0
                                 ? (n - 1 - 1 - 1 + 1) / 1
                                 : (n - 1 - 1 - 1 + 1) / 1 + 1;
  int __j_total_iters__7__ = (m - 1 - 1 - 1 + 1) % 1 == 0
                                 ? (m - 1 - 1 - 1 + 1) / 1
                                 : (m - 1 - 1 - 1 + 1) / 1 + 1;
  int __final_total_iters__8__ =
      1 * __i_total_iters__6__ * __j_total_iters__7__;
  int __i_interval__9__ = __j_total_iters__7__ * 1;
  int __j_interval__10__ = 1;
  int __collapsed_index__11__;
  int __i_total_iters__12__ =
      (n - 1 - 0 + 1) % 1 == 0 ? (n - 1 - 0 + 1) / 1 : (n - 1 - 0 + 1) / 1 + 1;
  int __j_total_iters__13__ =
      (m - 1 - 0 + 1) % 1 == 0 ? (m - 1 - 0 + 1) / 1 : (m - 1 - 0 + 1) / 1 + 1;
  int __final_total_iters__14__ =
      1 * __i_total_iters__12__ * __j_total_iters__13__;
  ...
  int __collapsed_index__17__;
  {
    ...
    long p_lower_;
    long p_upper_;
    XOMP_loop_default(0, __final_total_iters__14__ - 1, 1, &p_lower_,
                      &p_upper_);
    for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
  ...
  }
  {
    ...
    for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
      ...
      _p_resid = (*ax * (uold[_p_i - 1][_p_j] + uold[_p_i + 1][_p_j]) +
                  *ay * (uold[_p_i][_p_j - 1] + uold[_p_i][_p_j + 1]) +
                  *b * uold[_p_i][_p_j] - f[_p_i][_p_j]) /
                 *b;
...
static void OUT__3__10454__(void *__out_argv) {
  int *__final_total_iters__20__ =
      (int *)(((struct OUT__3__10454___data *)__out_argv)
                  ->__final_total_iters__20___p);
  int *__i_interval__21__ = (int *)(((struct OUT__3__10454___data *)__out_argv)
                                        ->__i_interval__21___p);
  ...
  for (p_index_ = p_lower_; p_index_ <= p_upper_; p_index_ += 1) {
    ...
    f[_p_i][_p_j] = ((float)(-1.00000 * ((double)alpha) *
                                 (1.0 - ((double)(_p_xx * _p_xx))) *
                                 (1.0 - ((double)(_p_yy * _p_yy))) -
                             2.0 * (1.0 - ((double)(_p_xx * _p_xx))) -
                             2.0 * (1.0 - ((double)(_p_yy * _p_yy)))));
  }
  XOMP_barrier();
}
