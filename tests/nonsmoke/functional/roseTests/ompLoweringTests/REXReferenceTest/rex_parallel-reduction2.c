...
static void OUT__1__4685__(int *__global_tid, int *__bound_tid,
                           void *__out_argv);
...
static void OUT__2__4685__(int *__global_tid, int *__bound_tid,
                           void *__out_argv);
...
static void OUT__1__4685__(int *__global_tid, int *__bound_tid,
  ...
  int *thread_num =
      (int *)(((struct OUT__1__4685___data *)__out_argv)->thread_num_p);
  int _p_sum;
...
static void OUT__2__4685__(int *__global_tid, int *__bound_tid,
  ...
  int *thread_num =
      (int *)(((struct OUT__2__4685___data *)__out_argv)->thread_num_p);
  int _p_sum;
  _p_sum = 0;
  if (__kmpc_single(0, *__global_tid)) {
    {
