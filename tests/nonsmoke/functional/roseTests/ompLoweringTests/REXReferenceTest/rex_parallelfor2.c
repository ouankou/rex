...
static void OUT__1__3994__(int *__global_tid, int *__bound_tid,
                           void *__out_argv);
...
static void OUT__1__3994__(int *__global_tid, int *__bound_tid,
                           void *__out_argv) {
  int (*a)[1000] =
      (int (*)[1000])(((struct OUT__1__3994___data *)__out_argv)->a_p);
  int _p_i;
  int __index_;
  int __lower_ = 0;
  int __upper_ = 999;
  int __stride_ = 1;
  int __last_iter_ = 0;
  __kmpc_for_static_init_4(0, *__global_tid, 34, &__last_iter_, &__lower_,
                           &__upper_, &__stride_, 1, 1);
  if (__upper_ > 999)
    __upper_ = 999;
