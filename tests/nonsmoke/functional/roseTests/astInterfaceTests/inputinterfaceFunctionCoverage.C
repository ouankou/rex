...
public:
  ...
  bool operator==(int y) { return (i == y); }
};

void test_splitVariableDeclaration() { int i = 100; }

void test_setOperand() { int j = 12345; }
...
int &MyList::operator[](const int index) { return plist[index]; }
