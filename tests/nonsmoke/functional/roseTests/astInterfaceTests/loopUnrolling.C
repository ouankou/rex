...

{
  ...
  if (!CommandlineProcessing::isOptionWithParameter(
          argvList, "-rose:loopunroll:", "line", line, true) ||
      !CommandlineProcessing::isOptionWithParameter(
          argvList, "-rose:loopunroll:", "factor", factor, true)) {
    cout << "Usage: loopUnrolling inputFile.c -rose:loopunroll:line "
            "<line_number> -rose:loopunroll:factor N"
         << endl;
    return 0;
  }
