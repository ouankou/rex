...

{
  ...
  Rose_STL_Container<SgNode *> addOps =
      NodeQuery::querySubTree(body, V_SgAddOp);
  ...
  SgExpression *pattern_exp =
      buildFunctionCallExp(s_name, buildVoidType(), parameter_list, body);
