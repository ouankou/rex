...
int main(int argc, char *argv[]) {
  ...
  // DQ (3/20/2017): Build value expressions not tested elsewhere.
  SgUnsignedLongLongIntVal *unsignedLongLongIntValue =
      buildUnsignedLongLongIntVal(42);
  SgExprStatement *exprStatement_16 =
      buildExprStatement(unsignedLongLongIntValue);
  laststmt = getLastStatement(topScopeStack());
  insertStatementBefore(laststmt, exprStatement_16);

  // DQ (3/20/2017): Build value expressions not tested elsewhere.
  SgUnsignedLongLongIntVal *hexUnsignedLongLongIntValue =
      buildUnsignedLongLongIntValHex(42);
  SgExprStatement *exprStatement_17 =
      buildExprStatement(hexUnsignedLongLongIntValue);
  laststmt = getLastStatement(topScopeStack());
