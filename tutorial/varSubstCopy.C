...
public:
  SgVarSubstCopy(SgVariableSymbol *sourceSymbol,
                 SgExpression *replacementExpression)
...
int main(int argc, char **argv) {
  ...
  SgFunctionSymbol *exampleFunctionSym =
      global->lookup_function_symbol("exampleFunction");
  ROSE_ASSERT(exampleFunctionSym != NULL);
  SgFunctionDeclaration *exampleFunctionDecl =
      exampleFunctionSym->get_declaration();
  ROSE_ASSERT(exampleFunctionDecl != NULL);
  SgFunctionDefinition *exampleFunctionDef =
  ...
  SgVariableSymbol *firstParamSym =
      exampleFunctionDef->lookup_var_symbol(firstParamName->get_name());
  ...
  SgFunctionDeclaration *exampleFunctionDeclCopy =
      isSgFunctionDeclaration(exampleFunctionDeclCopyNode);
  ...
  global->get_symbol_table()->insert(
      exampleFunctionDeclCopy->get_name(),
      new SgFunctionSymbol(exampleFunctionDeclCopy));
