...
// template<class _Value,class _Hash = hash<_Value>,class _Pred =
// std::equal_to<_Value>,class _Alloc = std::allocator<_Value>,bool
// __cache_hash_code = false>
...
namespace {
typedef hash_map<const char *, long, hash<const char *>, streq>
    SymbolsByNameMap;
typedef hash_map<const char *, const FileDescriptor *, hash<const char *>,
                 streq>
    FilesByNameMap;
