...
protected:
    ...
    std::string generatedDirName;                       // directory name where generated files are written
    Rose::FileSystem::Path generatedDir;                // directory where generated files are written
