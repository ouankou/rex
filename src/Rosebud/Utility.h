...
struct Settings {
    std::string backend = "rosetta";                    /**< Name of main backend code generator to use. */
    std::string serializer = "none";                    /**< Name of the serializer code generator to use. */
...
Rose::FileSystem::Path findRoseRootDir(const Rose::FileSystem::Path&);
...
Rose::FileSystem::Path relativeToRoseSource(const Rose::FileSystem::Path&);
...
Rose::FileSystem::Path toPath(const std::string &symbol, const std::string &extension);
