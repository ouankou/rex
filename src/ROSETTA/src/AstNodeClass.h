...
public:
  ...
  // DQ (3/7/2007): Building support for "long getChildIndex();" to be use for
  // "bool isChild();" and other purposes.
  std::string buildChildIndex();
  // DQ (9/28/2022): Fixing compiler warning for argument not used.
  // std::string buildListIteratorStringForChildIndex(std::string typeName,
  // std::string variableName, std::string classNameString);
  std::string buildListIteratorStringForChildIndex(std::string typeName,
                                                   std::string variableName);
