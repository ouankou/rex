...
// Common OpenMP nodes for both C/C++ and Fortran, Liao, 5/29/2009
  ...
  // string explicit, we are not using the SgLinkageModifier (which might be a better idea).
     ...
     // DeclarationStatement.setDataPrototype("bool", "need_name_qualifier", "=
     // false",
     ...
     //             NO_CONSTRUCTOR_PARAMETER, BUILD_ACCESS_FUNCTIONS,
     //             NO_TRAVERSAL, NO_DELETE);
     //   DeclarationStatement.setDataPrototype("SgSymbolPtrList",
     //   "name_qualifier_list", "",
     //             NO_CONSTRUCTOR_PARAMETER, BUILD_ACCESS_FUNCTIONS,
     //             NO_TRAVERSAL, NO_DELETE);
     ...
     // DeclarationStatement.setDataPrototype ("SgDeclarationStatement*",
