...
// DQ (5/24/2005): This builds a function to report the sizes of each type of IR
// node. This is part of an attempt to evaluate how we can make the IR more
// compact as part of support for the reading a whole project into memory.
string Grammar::buildMemoryStorageEvaluationSupport() {
