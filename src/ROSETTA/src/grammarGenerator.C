...
// DQ (9/28/2022): Fixing compiler warning for argument not used.
#if 1
Grammar::GrammarSynthesizedAttribute Grammar::CreateMinimalTraversedGrammarSymbolsSet(
    AstNodeClass *grammarnode, vector<Grammar::GrammarSynthesizedAttribute> v)
#else
Grammar::GrammarSynthesizedAttribute
...
#if 1
Grammar::GrammarSynthesizedAttribute 
Grammar::CreateAbstractTreeGrammarString(AstNodeClass* grammarnode, vector<GrammarSynthesizedAttribute> v)
#else
Grammar::GrammarSynthesizedAttribute 
