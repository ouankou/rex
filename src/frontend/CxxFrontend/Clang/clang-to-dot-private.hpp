...
// DQ (11/27/2020): Turn on the debugging information as we visit clang IR
// nodes.
...
protected:
  void VisitTemplateArgument(const clang::TemplateArgument &template_argument,
...
public:
  // ClangToDot(clang::CompilerInstance * compiler_instance, Language
  // language_);
  ClangToDotTranslator(clang::CompilerInstance *compiler_instance,
                       Language language_);
  ...
  */
  ...
  virtual bool VisitCapturedDecl(clang::CapturedDecl *capture_decl,
                                 NodeDescriptor &node_desc);
  virtual bool VisitEmptyDecl(clang::EmptyDecl *empty_decl,
                              NodeDescriptor &node_desc);
  virtual bool VisitExportDecl(clang::ExportDecl *export_decl,
                               NodeDescriptor &node_desc);
  ...
  VisitFriendTemplateDecl(clang::FriendTemplateDecl *friend_template_decl,
                          NodeDescriptor &node_desc);
  virtual bool VisitImportDecl(clang::ImportDecl *import_decl,
                               NodeDescriptor &node_desc);
  ...
  virtual bool VisitTypeAliasDecl(clang::TypeAliasDecl *type_alias_decl,
                                  NodeDescriptor &node_desc);
  // virtual bool VisitObjCTypeParamDecl(clang::ObjCTypeParamDecl *
  // obj_type_param_decl, NodeDescriptor & node_desc);
  virtual bool VisitUnresolvedUsingTypenameDecl(
      clang::UnresolvedUsingTypenameDecl *unresolved_using_type_name_decl,
      NodeDescriptor &node_desc);
  virtual bool VisitUsingDecl(clang::UsingDecl *using_decl,
                              NodeDescriptor &node_desc);
  virtual bool
  ...
  virtual bool VisitPragmaDetectMismatchDecl(
      clang::PragmaDetectMismatchDecl *pragma_detect_mismatch,
      NodeDescriptor &node_desc);
  virtual bool
  ...
  */
  ...
  virtual bool VisitAsmStmt(clang::AsmStmt *asm_stmt,
                            NodeDescriptor &node_desc);
  virtual bool VisitGCCAsmStmt(clang::GCCAsmStmt *gcc_asm_stmt,
                               NodeDescriptor &node_desc);
  virtual bool VisitMSAsmStmt(clang::MSAsmStmt *ms_asm_stmt,
                              NodeDescriptor &node_desc);
  ...
  virtual bool VisitSwitchStmt(clang::SwitchStmt *switch_stmt,
                               NodeDescriptor &node_desc);
  virtual bool VisitValueStmt(clang::ValueStmt *value_stmt,
                              NodeDescriptor &node_desc);
  ...
  // concept_specialization_expr, NodeDescriptor & node_desc);
  virtual bool
  ...
  // cxx_rewrite_binary_operator, NodeDescriptor & node_desc);
  ...
  virtual bool VisitFloatingLiteral(clang::FloatingLiteral *floating_literal,
                                    NodeDescriptor &node_desc);
  virtual bool VisitFullExpr(clang::FullExpr *full_expr,
                             NodeDescriptor &node_desc);
  ...
  virtual bool VisitIntegerLiteral(clang::IntegerLiteral *integer_literal,
                                   NodeDescriptor &node_desc);
  virtual bool VisitLambdaExpr(clang::LambdaExpr *lambda_expr,
                               NodeDescriptor &node_desc);
  ...
  virtual bool VisitMSPropertySubscriptExpr(
      ...
      NodeDescriptor &node_desc);
  virtual bool VisitNoInitExpr(clang::NoInitExpr *no_init_expr,
                               NodeDescriptor &node_desc);
  ...
  */
  ...
  VisitVariableArrayType(clang::VariableArrayType *variable_array_type,
                         NodeDescriptor &node_desc);
  virtual bool VisitAtomicType(clang::AtomicType *atomic_type,
                               NodeDescriptor &node_desc);
  ...
  virtual bool VisitParenType(clang::ParenType *paren_type,
                              NodeDescriptor &node_desc);
  virtual bool VisitPipeType(clang::PipeType *pipe_type,
                             NodeDescriptor &node_desc);
...
// class PreprocessorInserter : public
// AstTopDownProcessing<NextPreprocessorToInsert *>
class ClangToDotPreprocessorInserter
    : public AstTopDownProcessing<ClangToDotNextPreprocessorToInsert *> {
public:
  ClangToDotNextPreprocessorToInsert *evaluateInheritedAttribute(
      SgNode *astNode, ClangToDotNextPreprocessorToInsert *inheritedValue);

private:
  std::vector<std::unique_ptr<ClangToDotNextPreprocessorToInsert>>
      owned_inherited_;
};
