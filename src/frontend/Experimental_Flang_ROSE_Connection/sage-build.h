...
void Build(std::list<Fortran::parser::ImplicitSpec> &, std::list<std::tuple<SgType*, std::list<std::tuple<char, std::optional<char>>>>> &implicit_spec_list);
void Build(Fortran::parser::ImplicitSpec &, SgType* &type, std::list<std::tuple<char, std::optional<char>>> &letter_spec_list);
void Build(std::list<Fortran::parser::LetterSpec> &, std::list<std::tuple<char, std::optional<char>>> &letter_spec_list);
void Build(Fortran::parser::LetterSpec &, std::tuple<char, std::optional<char>> &letter_spec);
