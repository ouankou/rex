...
void BuildVisitor::Build(parser::MainProgram &x) {
  ...
  builder.Enter(programDecl, opt_name, labels, SourcePositions{*srcPosBegin,*srcPosBody,srcPosEnd}, comments);
...
void Build(std::list<parser::ImplicitSpec> &x, std::list<std::tuple<SgType*, std::list<std::tuple<char, std::optional<char>>>>> &implicit_spec_list)
{
...
void Build(parser::ImplicitSpec &x, SgType* &type, std::list<std::tuple<char, std::optional<char>>> &letter_spec_list)
{
...
void Build(std::list<parser::LetterSpec> &x, std::list<std::tuple<char, std::optional<char>>> &letter_spec_list)
{
...
void Build(parser::LetterSpec &x, std::tuple<char, std::optional<char>> &letter_spec)
{
