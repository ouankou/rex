...
int omp_target_memcpy(void *dst, void *src, size_t _length, size_t dst_offset,
...
int omp_target_associate_ptr(void *host_ptr, void *device_ptr, size_t _size,
