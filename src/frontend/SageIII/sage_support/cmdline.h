...
// This text comes directly from the LicenseInformation/ROSE_BSD_License.txt
...
void makeSysIncludeList(const Rose_STL_Container<string> &dirs,
...
// --param
void ProcessParam(SgProject *project, std::vector<std::string> &argv);
} // namespace Gnu
} // namespace Cmdline
} // namespace Rose
