...
struct token_element {
  ...
  // A token can also be an already processed CPP directive or comment
  // (PreprocessingInfo) PreprocessingInfo* token_preprocessingInfo;
...
struct stream_element {
  ...
  // The token stream can also include references to already processed CPP
  // directives or comments (PreprocessingInfo)
...
// At present this is an STL list, but I would like it to be a vector at some
// point
