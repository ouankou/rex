...
// DQ (4/21/2009): Error checking to avoid difficult to debug ODR violations on
// 32-bit systems.
#if defined(_SYS_STAT_H)
#error                                                                         \
    "sys/stat.h should not have been included before the _FILE_OFFSET_BITS macro is set! (use rose.h first...)"
#endif
...
// controling size of "struct stat"
#if !defined(__sun)
