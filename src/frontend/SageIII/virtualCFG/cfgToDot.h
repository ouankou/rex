...
// From cfgToDot.C:
ROSE_DLL_API std::ostream &cfgToDot(std::ostream &o, std::string graphName,
                                    CFGNode start);
ROSE_DLL_API std::ostream &cfgToDot(std::ostream &o, std::string graphName,
                                    InterestingNode start);

ROSE_DLL_API std::ostream &
cfgToDotForDebugging(std::ostream &o, std::string graphName, CFGNode start);
ROSE_DLL_API std::ostream &cfgToDotForDebugging(std::ostream &o,
...
ROSE_DLL_API void interestingCfgToDot(SgNode *start,
                                      const std::string &file_name);

//! Dump the full dot graph of a virtual control flow graph starting from SgNode
//! (start)
ROSE_DLL_API void cfgToDotForDebugging(SgNode *start,
                                       const std::string &file_name);
} // namespace VirtualCFG
