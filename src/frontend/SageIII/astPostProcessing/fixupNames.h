...
declarations that are inconsistant (e.g SgclassDeclarations).
    ...
    This traversal uses the Memory Pool traversal to fixup names that are
inconsistant across defining vs. non-defining declarations and additional
non-defining declaration can can exist in the AST.
 */
