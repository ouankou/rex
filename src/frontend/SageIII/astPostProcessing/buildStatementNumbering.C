...
void SgGlobal::buildStatementNumbering() {
  ...
  // DQ (9/11/2009): Measure the cost of the renumbering to support the name
  // qualification.
  TimingPerformance timer(
      "Statement sequence numbering (name qualification support):");
...
void fixupUsingNamespaceDeclarations() {
