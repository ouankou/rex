...
// (unparsed) code.  An example of this is test2016_109.C which is taken from a
// slightly more complex version (test2016_52.C and test2016_53.C).  This was
// not a problem with older versions of the GNU compiler because they didn't
// enforce the rule about using private types in template instantiations. GNU
// version 6.1 does enforce this (and likely versions between GNU version 4.8
// and version 6.1).

// When this happens there is always an alternative type that legacy frontend
// could have used, and the trick is to identify it and provide a pointer to use
