...
// DQ (4/24/2013): This class controls the output of template declarations in
...
public:
  ...
  std::map<SgFunctionDeclaration *, SetStructure *>
      mapOfSetsOfFunctionDeclarations;

  //! Constructor to provide access to file's backend specific template
  //! instantiation options
  FixupFunctionDefaultArguments(SgSourceFile *file);

  //! Required traversal function
  FixupFunctionDefaultArgumentsInheritedAttribute evaluateInheritedAttribute(
      SgNode *node,
