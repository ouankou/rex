...
public:
  ...
  FixupInitializersUsingIncludeFilesInheritedAttribute(
      const FixupInitializersUsingIncludeFilesInheritedAttribute &);
  FixupInitializersUsingIncludeFilesInheritedAttribute &operator=(
      const FixupInitializersUsingIncludeFilesInheritedAttribute &) = default;
};
...
public:
  ...
  FixupInitializersUsingIncludeFilesSynthesizedAttribute &operator=(
      const FixupInitializersUsingIncludeFilesSynthesizedAttribute &) = default;
};

/*! \brief Fixup known ways in which inlcude files are used to initialized
   variable.

    This is lower level support for the
   fixupInitializersUsingIncludeFiles(SgNode*) function.
...
public:
  ...
  void findAndRemoveMatchingInclude(
