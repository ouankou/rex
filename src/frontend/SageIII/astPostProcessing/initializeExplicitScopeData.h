...
/*! \brief Support for initialization of explicit scopes (located only at
   specific IR nodes).

    This function initializes any uninitialized explicit scope data members.
   Some IR nodes have explicit scope information where the parent pointer is
   insufficient to identify the scope because of structural flexability in the
   layout of the C++ source code.

    \internal The explicitly stored scope information is called by the
...
// DQ (7/26/2007): Modified to reflect use of memory pool as an alternative
// traversal. class InitializeExplicitScopes : public SgSimpleProcessing
