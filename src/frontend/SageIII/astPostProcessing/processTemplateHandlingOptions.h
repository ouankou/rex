...
// DQ (8/19/2005):
/*! \brief Fixup template instantiations to unmark them for output following
semantics of gnu template options

\implementation This is support for -fno-implicit-templates option and
...
public:
  ProcessTemplateHandlingOptions(SgFile *file, bool buildImplicitTemplates,
                                 bool buildImplicitInlineTemplates);
