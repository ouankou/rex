...
public:
  RemoveInitializedNamePtrInheritedAttribute()
      : firstInitializedNameVisited(false), parentNode(NULL) {}
...
class RemoveInitializedNamePtr
    : public SgTopDownProcessing<RemoveInitializedNamePtrInheritedAttribute> {
public:
...
// DQ (8/20/2005): Changed name of subTemporaryAstFixes() to
// removeInitializedNamePtr() to match the design of the other AST fixup
// operations in this directory.
void removeInitializedNamePtr(SgNode *node);

// [MS]: delete AST nodes which represent operators and do not have any
// successor. case1: SgDotExp: can have 2 successors, both can be null
