...
// use new_filename. This function is defined in preproc.C and used to collect
// the attributes extern ROSEAttributesList *getPreprocessorDirectives(const
// char *fileName); extern ROSEAttributesList *getPreprocessorDirectives(const
// char *fileName); ROSEAttributesList *getPreprocessorDirectives(const char
// *fileName); ROSEAttributesList *getPreprocessorDirectives( std::string
// fileName ); ROSEAttributesList *getPreprocessorDirectives( std::string
// fileName, LexTokenStreamTypePointer & input_token_stream_pointer );
