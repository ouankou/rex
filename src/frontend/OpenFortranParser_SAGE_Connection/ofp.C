...
{  
    ...
    jmethodID get_error_method = jofp_get_frontEnd_getError_method(front_end_class);

    jserver_callMethod(front_end_class, main_method, args);
    int retval = jserver_callStaticBooleanMethod(front_end_class, get_error_method);
...
static jmethodID 
jofp_get_frontEnd_main_method(jclass front_end_class)
{
...
static jmethodID 
jofp_get_frontEnd_getError_method(jclass front_end_class)
{
