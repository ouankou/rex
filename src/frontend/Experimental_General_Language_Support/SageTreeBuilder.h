...
public:
  ...
  void Leave(SgFunctionParameterList *, SgScopeStatement *,
             const std::list<LanguageTranslation::FormalParameter> &);
  void Leave(SgFunctionParameterList *, SgScopeStatement *,
  ...
  void Enter(SgVariableDeclaration *&, SgType *,
             std::list<std::tuple<std::string, SgType *, SgExpression *>> &);
  ...
  void Enter(SgExprStatement *&, const std::string &, SgExprListExp *,
             const std::string &);
  ...
  // Expressions
  //
  void Enter(SgFunctionCallExp *&, const std::string &name,
             SgExprListExp *params);
  void Enter(SgCastExp *&, const std::string &name, SgExpression *cast_operand);
  void Enter(SgPntrArrRefExp *&, const std::string &name,
             SgExprListExp *subscripts, SgExprListExp *cosubscripts);
  void Enter(SgVarRefExp *&, const std::string &name,
             bool compiler_generate = false);
...
public:
  ...
  SgPointerType *buildPointerType(const std::string &base_type_name,
                                  SgType *base_type);
};
...
SgFunctionCallExp *
buildIntrinsicFunctionCallExp_nfi(const std::string &name,
