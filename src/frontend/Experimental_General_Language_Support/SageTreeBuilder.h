...
//using SourcePositions    = std::tuple<SourcePosition, SourcePosition, SourcePosition>;
using SourcePositionPair = std::tuple<SourcePosition, SourcePosition>;
using SourcePositions = std::tuple<SourcePosition, SourcePosition, SourcePosition>;
...
//
   ...
   void Enter(SgProcessControlStatement* &, const std::string &, const std::optional<SgExpression*> &,
   ...
   void Enter(SgImplicitStatement* &, std::list<std::tuple<SgType*, std::list<std::tuple<char, std::optional<char>>>>> &);
