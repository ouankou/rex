...
protected:
  ...
  void setSourcePositions(ATerm term, rb::SourcePosition &start,
                          rb::SourcePosition &end);

  void setSourcePosition(SgLocatedNode *node, PosInfo &pos);
  void setSourcePosition(SgLocatedNode *node, const std::string &filename,
                         PosInfo &pos);

  void setSourcePositionFrom(SgLocatedNode *node, SgLocatedNode *fromNode);
  void setSourcePositionFromEndOnly(SgLocatedNode *node,
                                    SgLocatedNode *fromNode);

  void setSourcePosition(SgLocatedNode *node, ATerm term);
  void setSourcePositionExcludingTerm(SgLocatedNode *node, ATerm startTerm,
                                      ATerm endTerm);
  void setSourcePositionIncludingTerm(SgLocatedNode *node, ATerm startTerm,
                                      ATerm endTerm);
  void setSourcePositionIncludingNode(SgLocatedNode *node, ATerm startTerm,
