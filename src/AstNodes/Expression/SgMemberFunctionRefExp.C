...
int
SgMemberFunctionRefExp::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgMemberFunctionRefExp::set_explicit_name_qualification_length(
...
bool
SgMemberFunctionRefExp::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgMemberFunctionRefExp::set_explicit_global_qualification(
...
SgStringList &
SgMemberFunctionRefExp::get_explicit_name_qualification_tokens()
   {
     ROSE_ASSERT(this != NULL);
     return p_explicit_name_qualification_tokens;
   }
...
void
SgMemberFunctionRefExp::set_explicit_name_qualification_tokens(
