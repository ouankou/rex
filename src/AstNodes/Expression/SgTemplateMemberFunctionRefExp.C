...
int
SgTemplateMemberFunctionRefExp::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgTemplateMemberFunctionRefExp::set_explicit_name_qualification_length(
...
bool
SgTemplateMemberFunctionRefExp::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgTemplateMemberFunctionRefExp::set_explicit_global_qualification(
...
void
SgTemplateMemberFunctionRefExp::set_explicit_name_qualification_tokens(
