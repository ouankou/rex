...
int
SgFunctionRefExp::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgFunctionRefExp::set_explicit_name_qualification_length(
...
bool
SgFunctionRefExp::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgFunctionRefExp::set_explicit_global_qualification(
...
SgStringList &
SgFunctionRefExp::get_explicit_name_qualification_tokens()
   {
     ROSE_ASSERT(this != NULL);
     return p_explicit_name_qualification_tokens;
   }
...
void
SgFunctionRefExp::set_explicit_name_qualification_tokens(
