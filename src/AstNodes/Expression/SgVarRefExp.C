...
int
SgVarRefExp::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgVarRefExp::set_explicit_name_qualification_length(
...
bool
SgVarRefExp::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgVarRefExp::set_explicit_global_qualification(
...
SgStringList &
SgVarRefExp::get_explicit_name_qualification_tokens()
   {
     ROSE_ASSERT(this != NULL);
     return p_explicit_name_qualification_tokens;
   }
...
void
SgVarRefExp::set_explicit_name_qualification_tokens(
