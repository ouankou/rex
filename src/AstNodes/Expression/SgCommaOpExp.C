...
SgType *SgCommaOpExp::get_type() const {
  ...
  // but it should because its semantics is different from the default
  // SgBinaryOp::get_type() which returns the type associated with the lhs. This
  // returns the type of the rhs.
