...
int
SgTemplateFunctionRefExp::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgTemplateFunctionRefExp::set_explicit_name_qualification_length(
...
bool
SgTemplateFunctionRefExp::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgTemplateFunctionRefExp::set_explicit_global_qualification(
...
void
SgTemplateFunctionRefExp::set_explicit_name_qualification_tokens(
