...
int
SgEnumVal::get_explicit_name_qualification_length() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgEnumVal::set_explicit_name_qualification_length(
...
bool
SgEnumVal::get_explicit_global_qualification() const
   {
     ROSE_ASSERT(this != NULL);
...
void
SgEnumVal::set_explicit_global_qualification(
...
const SgStringList &
SgEnumVal::get_explicit_name_qualification_tokens() const
   {
     ROSE_ASSERT(this != NULL);
...
SgStringList &
SgEnumVal::get_explicit_name_qualification_tokens()
   {
     ROSE_ASSERT(this != NULL);
     return p_explicit_name_qualification_tokens;
   }
...
void
SgEnumVal::set_explicit_name_qualification_tokens(
