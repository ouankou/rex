 ...
 *
 * This library holds functions that are generally useful for a broad
 * cross-section of transformations. Support includes:
 ...
 * - Extraction of names from AST nodes (or subtrees): function names, type
 * names, etc.
 *
 * Authors: Quinlan.
 *
 ...
 *
 * Internal: Consider whether this should be a subgroup of the AST rewrite
 * mechanism.
 *
 * TODO: Fix up interfaces in Sage III using code from the TransformationSupport
 * class.
 *
