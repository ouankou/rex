 ...
 *
 * Generates C++ source code directly from the AST (older style code that
 * predates the newer traversal mechanisms). Parts of this code were borrowed
 * from the original Sage II unparser. Internally, several options are available
 * so that the generated code can either reference the user's original source
 * code or the generated code. The generated output can use `#line` directives
