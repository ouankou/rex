...
//
//  Auxiliary function to test if this expression is an unary operator+
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryOperatorPlus(SgExpression *expr) {
...
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryOperatorMinus(SgExpression *expr) {
  SgMemberFunctionRefExp *mfunc_ref = isSgMemberFunctionRefExp(expr);
  if (mfunc_ref != NULL) {
    SgMemberFunctionSymbol *mfunc_sym = mfunc_ref->get_symbol();
    if (mfunc_sym != NULL) {
...
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryAddressOperator(SgExpression *expr) {
...
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryDereferenceOperator(SgExpression *expr) {
  // DQ (5/6/2007): This might be a non-member function and if so we don't
  // handle this case correctly! If it is a non-member function this it will
  // have a single argument ROSE_ASSERT(isSgFunctionRefExp(expr) == NULL);
  ASSERT_not_null(expr);
...
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryComplementOperator(SgExpression *expr) {
  // DQ (5/6/2007): This might be a non-member function and if so we don't
  // handle this case correctly! If it is a non-member function this it will
  // have a single argument ROSE_ASSERT(isSgFunctionRefExp(expr) == NULL);
  ASSERT_not_null(expr);
...
//  overloading function
//-----------------------------------------------------------------------------------
bool Unparse_MOD_SAGE::isUnaryNotOperator(SgExpression *expr) {
  // DQ (5/6/2007): This might be a non-member function and if so we don't
  // handle this case correctly! If it is a non-member function this it will
  // have a single argument ROSE_ASSERT(isSgFunctionRefExp(expr) == NULL);
  ASSERT_not_null(expr);
