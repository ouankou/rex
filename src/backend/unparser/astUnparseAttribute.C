...
void AstUnparseAttribute::addString(string s,
...
AstUnparseAttribute::AstUnparseAttribute(string s,
                                         RelativePositionType inputlocation) {
  // Add the string location pair to the list.
...
string AstUnparseAttribute::toString() {
  string s;
...
bool AstUnparseAttribute::replacementStringExists() {
  bool result = false;
