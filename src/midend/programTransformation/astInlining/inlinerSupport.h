...
ROSE_DLL_API void
renameLabels(SgNode *n, SgFunctionDefinition *enclosingFunctionDefinition);
...
ROSE_DLL_API void
removeUnusedVariables(SgNode *top,
                      const std::set<SgFunctionDeclaration *> &safeFunctions =
...
//! Check for consistancy of isTransformation flags for nodes marked as a
//! transformation.
