...
bool CPreproc::If::Case::isIf(void) const {
  return info_ && (info_->getTypeOfDirective() ==
                   PreprocessingInfo::CpreprocessorIfDeclaration);
}

bool CPreproc::If::Case::isIfdef(void) const {
  return info_ && (info_->getTypeOfDirective() ==
                   PreprocessingInfo::CpreprocessorIfdefDeclaration);
}

bool CPreproc::If::Case::isIfndef(void) const {
  return info_ && (info_->getTypeOfDirective() ==
                   PreprocessingInfo::CpreprocessorIfndefDeclaration);
}

bool CPreproc::If::Case::isElif(void) const {
  return info_ && (info_->getTypeOfDirective() ==
                   PreprocessingInfo::CpreprocessorElifDeclaration);
}

bool CPreproc::If::Case::isElse(void) const {
  return info_ && (info_->getTypeOfDirective() ==
                   PreprocessingInfo::CpreprocessorElseDeclaration);
}

bool CPreproc::If::Case::isEndif(void) const {
  return info_ && (info_->getTypeOfDirective() ==
...
string CPreproc::If::Case::getRaw(void) const {
  if (info_)
    return info_->getString();
  return string("");
}

string CPreproc::If::Case::getDirective(void) const {
  string tag;
  if (isIf())
    tag = "if";
  else if (isIfdef())
...
string CPreproc::If::Case::getCondition(void) const {
  return trim(allAfter(getRaw(), getDirective()));
}

SgLocatedNode *CPreproc::If::Case::getNode(void) { return node_; }

const SgLocatedNode *CPreproc::If::Case::getNode(void) const { return node_; }

PreprocessingInfo *CPreproc::If::Case::getInfo(void) { return info_; }

const PreprocessingInfo *CPreproc::If::Case::getInfo(void) const {
  return info_;
}

// ========================================================================

CPreproc::If::Case::iterator CPreproc::If::Case::begin(void) {
  return kids_.begin();
}

CPreproc::If::Case::const_iterator CPreproc::If::Case::begin(void) const {
  return kids_.begin();
}

CPreproc::If::Case::reverse_iterator CPreproc::If::Case::rbegin(void) {
  return kids_.rbegin();
}
...
CPreproc::If::Case::iterator CPreproc::If::Case::end(void) {
  return kids_.end();
}

CPreproc::If::Case::const_iterator CPreproc::If::Case::end(void) const {
  return kids_.end();
}

CPreproc::If::Case::reverse_iterator CPreproc::If::Case::rend(void) {
  return kids_.rend();
}
...
void CPreproc::If::Case::dump(size_t level /*=0*/) {
  ...
  cerr << indent(level) << getDirective() << " : "
       << "'" << getCondition() << "'" << ' ' << ASTtools::toStringFileLoc(n)
       << endl;
  CPreproc::dump(begin(), end(), level + 1);
}
// ========================================================================

void CPreproc::If::Case::appendChild(If *new_kid) {
  ROSE_ASSERT(!isEndif());
...
void CPreproc::If::Case::setIf(If *new_parent) { parent_ = new_parent; }

CPreproc::If *CPreproc::If::Case::getIf(void) { return parent_; }

const CPreproc::If *CPreproc::If::Case::getIf(void) const { return parent_; }

// ========================================================================

static string upTo(const string &s, const string &tag) {
...
static string allAfter(const string &s, const string &tag) {
  string::size_type pos = s.find(tag);
  if (pos != string::npos)
