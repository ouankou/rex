...
void dump(Ifs_t::const_iterator b, Ifs_t::const_iterator e, size_t level = 0);
...
void findIfDirectiveContext(const SgLocatedNode *target, Ifs_t &ifs,
                            If::Case *&top, If::Case *&bottom);
