...
// possible int count : = 2+ parameter count second parameter: function name of
// the outlined function in the shared library third parameter: filename of the
// shared library the remaining parameters: pointers to arguments to be passed
