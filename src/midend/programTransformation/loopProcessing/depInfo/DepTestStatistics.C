...
bool DepTestStatistics::CompareDepTests(unsigned int c, DepInfo a, DepInfo p,
                                        DepInfo o) {
  bool isDiff = false;
  int last;
...
unsigned int DepTestStatistics::RoseToPlatoDV(const DepRel dr) {
  ...
  case DEPDIR_EQ: {
    ...
    // std::cerr << "eq " << dr.GetMinAlign() << " " << dr.GetMaxAlign() << " "
    // << dr.toString() << std::endl;
  } break;
  case DEPDIR_LE: {
    dv = DDLES;
  } break;
...
void DepTestStatistics::GetEqualDVs(unsigned int *a, unsigned int *p,
                                    unsigned int *o) {
...
void DepTestStatistics::GetLessThanDVs(unsigned int *a, unsigned int *p,
                                       unsigned int *o) {
...
void DepTestStatistics::GetGreaterThanDVs(unsigned int *a, unsigned int *p,
                                          unsigned int *o) {
...
void DepTestStatistics::GetStarDVs(unsigned int *a, unsigned int *p,
                                   unsigned int *o) {
...
void DepTestStatistics::InitAdhocTime(void) { _adhoc_t0 = GetTime(); }

void DepTestStatistics::InitPlatoTime(void) { _plato_t0 = GetTime(); }

void DepTestStatistics::InitOmegaTime(void) { _omega_t0 = GetTime(); }
