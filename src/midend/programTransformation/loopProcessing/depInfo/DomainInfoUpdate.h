...
public:
  ...
  void operator()(DomainCond &d) { d.InsertLoop(level); }
};
...
public:
  ...
  void operator()(DomainCond &d) { d.MergeLoop(index1, index2); }
};
...
public:
  ...
  void operator()(DomainCond &d) { d.SwapLoop(index1, index2); }
};
...
public:
  ...
  void operator()(DomainCond &d) { d.RemoveLoop(level); }
};
...
public:
  ...
  void operator()(DomainCond &d) { d.AlignLoop(index, align); }
};
