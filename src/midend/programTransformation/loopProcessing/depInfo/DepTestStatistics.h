...
public:
  DepTestStatistics()
      : _total_problems(0), _num_diffs_adhoc_plato(0),
        _num_diffs_adhoc_omega(0), _num_diffs_plato_omega(0),
        _num_processed_adhoc(0), _num_processed_plato(0),
        _num_processed_omega(0), _num_no_dep_adhoc(0), _num_equal_dvs_adhoc(0),
        _num_less_than_dvs_adhoc(0), _num_greater_than_dvs_adhoc(0),
        _num_star_dvs_adhoc(0), _num_no_dep_plato(0), _num_equal_dvs_plato(0),
        _num_less_than_dvs_plato(0), _num_greater_than_dvs_plato(0),
        _num_star_dvs_plato(0), _num_no_dep_omega(0), _num_equal_dvs_omega(0),
        _num_less_than_dvs_omega(0), _num_greater_than_dvs_omega(0),
        _num_star_dvs_omega(0), _total_time_adhoc(0), _total_time_plato(0),
        _total_time_omega(0), _dep_test_choice(0) {};
