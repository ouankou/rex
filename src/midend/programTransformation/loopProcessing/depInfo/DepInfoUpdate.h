...
public:
  ...
  bool operator()(DepInfo &d, DepDirection dir) { return T(d, dir); }
...
public:
  ...
  bool operator()(DepInfo &d, DepDirection dir) {
    d.MergeLoop(srcIndex, desIndex, dir);
    return true;
  }
};
...
public:
  ...
  bool operator()(DepInfo &d, DepDirection dir) {
    d.SwapLoop(srcIndex, desIndex, dir);
    return true;
  }
};
