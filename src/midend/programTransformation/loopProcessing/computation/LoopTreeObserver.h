...
public:
  MergeLoopInfo(LoopTreeNode *o, LoopTreeNode *n, int a)
      : LoopTreeObserveInfo(o) {
    newLoop = n;
    align = a;
  }
...
public:
  InsertLoopInfo(LoopTreeNode *l) : LoopTreeObserveInfo(l) {}
...
public:
  SwapNodeInfo(LoopTreeNode *o, LoopTreeNode *other, int dir, const VarInfo &v)
      : LoopTreeObserveInfo(o), direction(dir), othernode(other), varinfo(v) {}
...
public:
  SplitStmtInfo(LoopTreeNode *stmt, LoopTreeNode *n, int l1, int l2,
                const DepRel &r)
...
public:
  SplitStmtInfo2(LoopTreeNode *stmt, LoopTreeNode *n, int l,
                 const SymbolicVal &mid)
