...
class ArrayInterface : public AstObserver,
                       ...
                       public ArrayAbstractionInterface {
private:
  ...
  void ObserveCopyAst(AstInterfaceImpl &fa, const AstNodePtr &orig,
  ...
  virtual SymbolicVal CreateArrayAccess(const SymbolicVal &,
                                        const SymbolicVal &);
  bool get_array_opt(CPPAstInterface &fa, const AstNodePtr &array,
                     ArrayOptDescriptor &d);
...
public:
  ...
  bool is_array_exp(CPPAstInterface &fa, const AstNodePtr &array, int *dimp = 0,
  ...
  AstNodePtr impl_access_array_length(CPPAstInterface &fa,
                                      const AstNodePtr &array, int dim,
                                      int plus = 0);
  AstNodePtr impl_access_array_elem(CPPAstInterface &fa,
  ...
  static ArrayInterface *get_inst(ArrayAnnotation &a, AstInterface &fa,
