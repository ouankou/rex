...
public:
  virtual FusionInfo operator()(CompSliceLocalityRegistry *anal,
                                CompSliceNest &n1, CompSliceNest &n2, int j,
                                int k, const DepInfo &e);
...
public:
  FusionInfo operator()(CompSliceLocalityRegistry *anal, CompSliceNest &n1,
                        CompSliceNest &n2, int j, int k, const DepInfo &e);
...
public:
  FusionInfo operator()(CompSliceLocalityRegistry *anal, CompSliceNest &n1,
                        CompSliceNest &n2, int j, int k, const DepInfo &e);
  virtual LoopTransformOptions::OptType GetOptimizationType() {
    return LoopTransformOptions::INNER_MOST_OPT;
  }
};
...
public:
  ...
  virtual bool Fusible(CompSliceLocalityRegistry *anal, CompSliceNest &n1,
                       CompSliceNest &n2, const DepInfo &e) const {
    return false;
  }
  virtual void Fuse(CompSliceLocalityRegistry *reg, CompSliceNest &n1,
...
public:
  ...
  bool Fusible(CompSliceLocalityRegistry *anal, CompSliceNest &n1,
               CompSliceNest &n2, const DepInfo &e) const;
  void Fuse(CompSliceLocalityRegistry *reg, CompSliceNest &n1,
            CompSliceNest &n2, DepInfo &e) const;
  virtual LoopTransformOptions::OptType GetOptimizationType() {
    return anal->GetOptimizationType();
  }
};
...
void SliceNestTypedFusion(CompSliceLocalityRegistry *anal,
                          CompSliceDepGraphCreate &t,
                          const LoopNestFusion &fuse);
void SliceNestReverseTypedFusion(CompSliceLocalityRegistry *anal,
                                 CompSliceDepGraphCreate &t,
                                 const LoopNestFusion &fuse);
