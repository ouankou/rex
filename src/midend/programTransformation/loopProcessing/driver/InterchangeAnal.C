...
void ArrangeNestingOrder ::RearrangeSliceNest(CompSliceNest &g,
                                              float *weightvec) {
...
void ArrangeNestingOrder ::operator()(CompSliceLocalityRegistry *anal,
                                      CompSliceNest &g) {
...
void ArrangeOrigNestingOrder ::SetNestingWeight(CompSliceLocalityRegistry *anal,
                                                CompSliceNest &g,
                                                float *weightvec) {
...
void ArrangeReuseOrder ::SetNestingWeight(CompSliceLocalityRegistry *anal,
                                          CompSliceNest &g, float *weightvec) {
  for (int i = 0; i < g.NumberOfEntries(); i++) {
