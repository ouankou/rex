...
private:
  NestInfo *impl;
  CompSliceDepGraphNode(MultiGraphCreate *g, LoopTreeDepComp &c,
                        DependenceHoisting &op);
  CompSliceDepGraphNode(MultiGraphCreate *g, LoopTreeDepComp &c,
                        DependenceHoisting &op, LoopTreeTransDepGraphCreate *t);
...
public:
  ...
  CompSliceDepGraphNode *CreateNode(LoopTreeDepComp &c,
                                    DependenceHoisting &op) {
...
typedef GraphAccessTemplate<CompSliceDepGraphNode, DepInfoEdge>
    CompSliceDepGraph;
