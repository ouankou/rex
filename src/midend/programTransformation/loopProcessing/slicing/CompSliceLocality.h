...
public:
  ...
  CompSliceLocalityAnal(LoopTreeLocalityAnal &a, unsigned ls,
                        unsigned _reuseDist)
...
public:
  ...
  public:
    SliceRelInfo(CompSliceLocalityAnal &anal, const CompSlice *slice1,
  ...
  public:
    ...
    void FuseSelfInfo(const SliceSelfInfo &that, const SliceRelInfo &rel) {
      ...
      const CompSliceLocalityAnal::AstNodeSet *tmpSet1 =
          rel.get_temporaryReuseSet();
    ...
    std::string toString() const {
      std::stringstream out;
      out << "spatial reuse: " << spatialReuses
          << "; Temporary reuse: " << TemporaryReuses();
      return out.str();
    }
  };
...
public:
  typedef LoopTreeLocalityAnal::AstNodeSet AstNodeSet;
  CompSliceLocalityRegistry(LoopTreeLocalityAnal &a, unsigned ls,
                            unsigned reuseDist);
