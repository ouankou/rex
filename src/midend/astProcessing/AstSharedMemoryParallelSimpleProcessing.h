// Author: Gergo Barany
// $Id: AstSharedMemoryParallelSimpleProcessing.h,v 1.1 2008/01/08 02:56:39
// dquinlan Exp $
...
public:
  ...
  typedef AstSharedMemoryParallelizableSimpleProcessing
...
public:
  ...
  typedef AstSharedMemoryParallelizablePrePostProcessing
      *ParallelizableTraversalPtr;
  typedef std::vector<ParallelizableTraversalPtr>
      ParallelizableTraversalPtrList;
