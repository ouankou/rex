...
// DQ (8/10/2004):
// This class appears to return a list of all traversed AST nodes.  It is
// equivalent to the AstQuery operator with the input variant V_SgNode.  Not
// sure how important this mechanism is (appears to be used in
// ASTConsistencyTests.[Ch]).
...
protected:
  ...
  virtual AstNodePtrSynAttr
  evaluateSynthesizedAttribute(SgNode *node, SynthesizedAttributesList);
