...
std::string AstAttributeDOT::get_color() { return color; }

std::string AstAttributeDOT::get_fontcolor() { return fontcolor; }

std::string AstAttributeDOT::get_fontname() { return fontname; }

void AstAttributeDOT::set_label(std::string l) { label = l; };

std::string AstAttributeDOT::get_label() { return label; };

bool AstAttributeDOT::get_keep() { return p_keep; }

void AstAttributeDOT::set_keep(bool p_k) { p_keep = p_k; }

void AstAttributeDOT::set_style(DOTStyles a_style) {
...
AstAttributeDOT::DOTStyles AstAttributeDOT::get_style() { return style; }
...
void AstAttributeDOT::set_color(std::string v_color) { color = v_color; }

void AstAttributeDOT::set_fontcolor(std::string v_fontcolor) {
  fontcolor = v_fontcolor;
}

void AstAttributeDOT::set_fontname(std::string v_fontname) {
  fontname = v_fontname;
}
...
void AstAttributeDOT::set_extra_options(std::string extraOptions) {
  ROSE_ASSERT(
      extraOptions.find(",") ==
      std::string::npos); // one option at a time, should not contain comma
...
std::string AstAttributeDOT::get_dot_options_string() {
  ...
  //\\N\",sides=6,peripheries=1,color=\"Blue\",fillcolor=red,fontname=\"7x13bold\",fontcolor=black,style=filled"
...
std::pair<SgNode *, SgNode *> DOTGraphEdge::get_edge() { return edgeNodes; };

void DOTGraphEdge::set_arrow_type(DOTArrowTypes a_arrow) {
  arrowType = a_arrow;
};

DOTGraphEdge::DOTArrowTypes DOTGraphEdge::get_arrow_type() { return arrowType; }
...
SgNode *DOTGraphNode::get_node() { return node; }

void DOTGraphNode::set_fillcolor(std::string v_fillcolor) {
  fillcolor = v_fillcolor;
}

std::string DOTGraphNode::get_fillcolor() { return fillcolor; }

void DOTGraphNode::set_shape(DOTShapeTypes a_shape) {
...
DOTGraphNode::DOTShapeTypes DOTGraphNode::get_shape() { return shape; }
...
std::vector<std::string> DOTGraphNode::get_dot_options_list() {
  std::vector<std::string> optionsStringVector =
      AstAttributeDOT::get_dot_options_list();
...
std::string DOTGraphNode::get_dot_options_string() {
  std::string optionsString;
