 ...
 *  is the base class implementation for DOTGraphNode and DOTGraphEdge. It is
 *meant to implement convenience functions to help building the string
 *representing DOT options and information like if the node should be filtered
 *out in a graph.
 *
 **************************************************************************************/
...
private:
  ...
  std::string color;
  // Set style for node or edge. For cluster subgraph, if "filled", the cluster
  // box's background is filled.
  DOTStyles style;
 ...
 *  The class
 *       class DOTGraphNode
 *  implements convenience functions specific to a graph node for building a dot
 *options string. It also contains information about which node in the AST we
 *operate on.
 **************************************************************************************/
 ...
 *  The class
 *       class DOTGraphEdge
 *  implements convenience functions specific to a graph edge for building a dot
 *options string. It also contains information about which edge in the AST we
 *operate on.
 **************************************************************************************/
...
private:
  // pair of nodes for an edge. The edge points from pair<>.first to
  // pair<>.second
