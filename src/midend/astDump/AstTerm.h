...
class AstTerm {
public:
  static std::string astTermToMultiLineString(SgNode *node, int sep = 1,
                                              int pos = 0);
  ...
  static std::string astTermWithNullValuesToString(SgNode *node,
                                                   bool withNumbers);
  static std::string
  astTermWithNullValuesToString(SgNode *node, bool withNumbers, bool withTypes);
  ...
  static std::string astTermToDot(RoseAst::iterator start,
