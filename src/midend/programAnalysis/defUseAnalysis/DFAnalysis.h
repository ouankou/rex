...
public:
  ...
  virtual std::vector<std::pair<SgInitializedName *, SgNode *>>
  ...
  /** get the vector of defining nodes for a specific node and a
   * initializedName. */
  virtual std::vector<SgNode *> getDefFor(SgNode *node,
                                          SgInitializedName *initName) = 0;

  /** get the vector of usage nodes for a specific node and a initializedName.
   */
  virtual std::vector<SgNode *> getUseFor(SgNode *node,
                                          SgInitializedName *initName) = 0;
  ...
  virtual std::map<SgNode *,
                   std::vector<std::pair<SgInitializedName *, SgNode *>>>
  getUseMap() = 0;
  virtual void setMaps(
      std::map<SgNode *, std::vector<std::pair<SgInitializedName *, SgNode *>>>
          def,
      std::map<SgNode *, std::vector<std::pair<SgInitializedName *, SgNode *>>>
          use) = 0;
};
