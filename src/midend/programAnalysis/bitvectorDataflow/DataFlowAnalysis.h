...
template <class Data> class DataFlowNode : public CFGNodeImpl {
protected:
  DataFlowNode(MultiGraphCreate *c) : CFGNodeImpl(c) {}
...
public:
  typedef
      typename CFGImplTemplate<Node, CFGEdgeImpl>::NodeIterator NodeIterator;
  typedef
      typename CFGImplTemplate<Node, CFGEdgeImpl>::EdgeIterator EdgeIterator;
