...
public:
  ...
  callingContext(procLocation *where, operandNode *call,
                 propertyAnalyzer *property_analyzer,
                 procedureAnn *procedure_annotations, procedureInfo *caller,
  ...
  inline propertyAnalyzer *property_analyzer() const {
