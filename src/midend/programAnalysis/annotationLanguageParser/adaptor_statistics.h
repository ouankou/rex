...
public:
  ...
  void make_CS(memoryBlock *block, procedureInfo *proc, Location *site,
...
private:
  ...
  void print_block_chain(memoryBlock *block, Destructions &destructions,
                         Complicits &complicits, memoryblock_set &printed,
                         string indent, string block_indent, ostream &out);
