...
public:
  ...
  annVariable(std::string name, std::string procedure_name, bool is_new,
              bool is_global, bool is_external, bool is_formal, bool is_io);
  ...
  // TB void save_bindings(procLocation * where) { _all_bindings[where] =
  // _bindings; }
#endif
