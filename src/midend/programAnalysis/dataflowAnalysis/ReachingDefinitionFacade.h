 ...
 * This class uses Facade design pattern to provide an easy interface for the
 * Reaching Definition Analysis. It hides the complex AstInterface,
 * AliasAnalysis etc and provides a much easier and cleaner access to
