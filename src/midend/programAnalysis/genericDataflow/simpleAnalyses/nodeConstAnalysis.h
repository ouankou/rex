...
// For each live variable records whether this variable has not been assigned,
// has one value or multiple values. There is one nodeConstAnalysisDebugLevel
// object for every variable
...
public:
  // public names for the different levels that correspond to the final outcome
  // of the analysis
