...
varIDSet &getFuncParamlScalars(const Function &func,
...
// sub-tree getCompilerGen - if =true, the returned set includes
// compiler-generated variables and doesn't if =false
