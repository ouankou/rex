...
class ReplaceParams : public MapObject<SymbolicVal, SymbolicVal>,
...
public:
  ...
  static std::string operator_signature(AstInterface &fa, const AstNodePtr &exp,
                                        AstInterface::AstNodeList *argp = 0,
...
template <class BaseClass> class OPDescriptorTemp : public BaseClass {
protected:
...
class OperatorSideEffectDescriptor
    : public OPDescriptorTemp<
          SetDescriptor<SymbolicValDescriptor, ',', '{', '}'>> {
...
public:
  ...
  typedef SetDescriptor<BaseDescriptor, ',', '{', '}'>::const_iterator
      const_iterator;
...
class OperatorInlineDescriptor
  ...
  typedef OPDescriptorTemp<CloseDescriptor<SymbolicValDescriptor, '{', '}'>>
      BaseClass;
