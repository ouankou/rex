...
public:
  ...
  //! Check if $n$ is a data member access operator; If yes, grab the object and
  //! the field name
  ...
  bool IsMemberFunctionCall(const AstNodePtr &n, AstNodePtr *obj = 0,
                            std::string *funcname = 0, AstNodePtr *access = 0,
