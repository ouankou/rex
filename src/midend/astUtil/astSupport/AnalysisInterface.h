...
public:
  ...
  //! traverses a function call to collect data being read. Returns the callee
  //! if requested.
  virtual bool get_read(AstInterface &fa, const AstNodePtr &fc,
                        CollectObject<AstNodePtr> *collect = 0) = 0;
  virtual bool get_call(AstInterface &, const AstNodePtr & /*fc*/,
                        CollectObject<AstNodePtr> * = nullptr) {
    return false;
  }
...
public:
  virtual bool get_modify(AstInterface &, const AstNodePtr &,
                          CollectObject<AstNodePtr> * = nullptr) override {
    return false;
  }
  virtual bool get_read(AstInterface &, const AstNodePtr &,
                        CollectObject<AstNodePtr> * = nullptr) override {
    return false;
  }
  virtual bool get_call(AstInterface &, const AstNodePtr &,
                        CollectObject<AstNodePtr> * = nullptr) override {
    return false;
  }
...
public:
  ...
  SideEffectAnalysisInterface()
      : modcollect(0), readcollect(0), killcollect(0), callcollect(0),
        varcollect(0), allocate_collect(0), free_collect(0), alias_collect(0) {}
...
protected:
  CollectObject *modcollect, *readcollect, *killcollect, *callcollect,
      *varcollect, *allocate_collect, *free_collect, *alias_collect;
};
...
public:
  virtual bool may_alias(AstInterface &, const AstNodePtr &, const AstNodePtr &,
                         CollectObject<std::pair<AstNodePtr, int>> &) {
    return false;
  }
...
public:
  ...
  virtual bool may_alias(AstInterface &fa, const AstNodePtr &r1,
                         const AstNodePtr &r2) = 0;
  virtual ~AliasAnalysisInterface() {}
};

class AssumeNoAlias : public AliasAnalysisInterface {
public:
  virtual bool may_alias(AstInterface &, const AstNodePtr &,
                         const AstNodePtr &) {
    return false;
  }
};
...
public:
   ...
   */
  virtual bool IsLoop(AstInterface &__fa, const AstNodePtr &__fc,
                      AstNodePtr *__init = 0, AstNodePtr *__cond = 0,
                      AstNodePtr *__incr = 0,
                      // SymbolicVal* __init = 0, SymbolicVal* __cond = 0,
                      // SymbolicVal* __incr = 0,
   ...
   */
  virtual bool IsFortranLoop(AstInterface &__fa, const AstNodePtr &__fc,
                             AstNodePtr *__ivar = 0, AstNodePtr *__start = 0,
                             AstNodePtr *__stop = 0, AstNodePtr *__step = 0,
                             AstNodePtr *__body = 0) const = 0;
};
