...
template <class AstNodePtr> class SideEffectAnalysisInterface {
public:
  ...
  virtual bool get_side_effect(AstInterface &fa, const AstNodePtr &stmts,
                               CollectObject *mod, CollectObject *read = 0,
