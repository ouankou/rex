...
typedef NameQuerySynthesizedAttributeType (*roseFunctionPointerOneParameter)(
    SgNode *);
typedef NameQuerySynthesizedAttributeType (*roseFunctionPointerTwoParameters)(
    SgNode *, std::string);
...
/**************************************************************************************************************
 * The function
 *    std::function<Rose_STL_Container<std::string>(SgNode *)>
 ...
 *AstQueryNamespace::AllNodes); returns a list of all strings in the sub-tree of
 ...
 *elementReturnType, AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); returns a list of all stings in the sub-tree of
 ...
 *defineQueryType = AstQueryNamespace::AllNodes); returns a list of all strings
 ...
 ********************************************************************************/
NameQuerySynthesizedAttributeType
queryMemoryPool(std::string traversal,
                roseFunctionPointerTwoParameters querySolverFunction,
