...
queryNodePragmaDeclarationFromName(SgNode *node, SgNode *nameNode);
...
Rose_STL_Container<SgNode *>
queryNodeVariableDeclarationFromName(SgNode *astNode, SgNode *nameNode);

NodeQuerySynthesizedAttributeType querySolverArguments(SgNode *astNode);

NodeQuerySynthesizedAttributeType
querySolverFunctionDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType
querySolverMemberFunctionDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType querySolverVariableTypes(SgNode *astNode);

NodeQuerySynthesizedAttributeType
querySolverVariableDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType querySolverClassDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType
querySolverStructDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType querySolverUnionDeclarations(SgNode *astNode);

NodeQuerySynthesizedAttributeType
querySolverTypedefDeclarations(SgNode *astNode);
...
NodeQuerySynthesizedAttributeType
querySolverFunctionDeclarationFromDefinition(SgNode *astNode,
                                             SgNode *functionDefinition);

NodeQuerySynthesizedAttributeType
querySolverGrammarElementFromVariant(SgNode *astNode, VariantT targetVariant);

// DQ (7/20/2004): Temporary output function to use in tests (to debug type
// traversals)
Rose_STL_Container<SgNode *> generateListOfTypes(SgNode *astNode);

void printNodeList(const Rose_STL_Container<SgNode *> &localList);

typedef AstQueryNamespace::AstQuery<AstSimpleProcessing,
                                    helpFunctionalOneParamater<SgNode *>>
    NodeAstQueryType;
typedef AstQueryNamespace::AstQuery<
    AstSimpleProcessing, helpFunctionalTwoParamaters<SgNode *, SgNode *>>
    NodeAstTwoParam;
typedef Rose_STL_Container<SgNode *> (*roseFunctionPointerOneParameter)(
    SgNode *);
typedef Rose_STL_Container<SgNode *> (*roseFunctionPointerTwoParameters)(
    SgNode *, SgNode *);
 ...
 *getFunction(TypeOfQueryTypeOneParameter oneParam); will return a functor
 *wrapping the pre-implemented function for TypeOfQueryTypeOneParameter.
 **************************************************************************************************************/
 ...
 * will return a functor wrapping the pre-implemented function for
 ...
 *AstQueryNamespace::AllNodes); returns all nodes produced by NodeFunctional
 *when applied to either all the nodes in a subTree or the children of the node
 *'subTree'.
 *******************************************************************************************/
...
// get the SgNode's conforming to the test in the TypeOfQueryTypeOneParamter the
// user specify.

/********************************************************************************************
 *
 * The function
 *   querySubTree (SgNode * subTree, TypeOfQueryTypeOneParameter
 *elementReturnType, AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); returns a list of all SgNodes in the sub-tree of
 *the variable 'subTree' found by the preimplemented function
 *'elementReturnType'.
 *******************************************************************************************/
...
ROSE_DLL_API NodeQuerySynthesizedAttributeType
queryNodeList(NodeQuerySynthesizedAttributeType nodeList,
              TypeOfQueryTypeOneParameter elementReturnType);

/********************************************************************************************
 *
 * The function
 *   querySubTree (SgNode * subTree, roseFunctionPointerOneParameter
 *elementReturnType, AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); returns a list of all SgNodes in the sub-tree of
 *the variable 'subTree' found by the function 'elementReturnType'.
 *******************************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
...
ROSE_DLL_API Rose_STL_Container<SgNode *>
queryNodeList(Rose_STL_Container<SgNode *> nodeList,
 ...
 *
 * The function
 *   querySubTree (SgNode * subTree, SgNode* traversal,
 *roseFunctionPointerTwoParameters elementReturnType,
 *        AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); returns a list of all SgNodes in the sub-tree of
 *the variable 'subTree' found by the function 'querySolverFunction' given a
 *second argument 'traversal'.
 *******************************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
querySubTree(SgNode *subTree, SgNode *traversal,
...
ROSE_DLL_API NodeQuerySynthesizedAttributeType
queryNodeList(NodeQuerySynthesizedAttributeType nodeList, SgNode *targetNode,
              roseFunctionPointerTwoParameters querySolverFunction);
 ...
 * The function
 *   querySubTree (SgNode * subTree, SgNode* traversal,
 *TypeOfQueryTypeTwoParameters elementReturnType, AstQueryNamespace::QueryDepth
 *defineQueryType = AstQueryNamespace::AllNodes); returns a list of all SgNodes
 *in the sub-tree of the variable 'subTree' found by the preimplemented function
 *'elementReturnType' given a second argument 'traversal'.
 *******************************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
querySubTree(SgNode *subTree, SgNode *traversal,
 ...
 *       AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); returns a list of all SgNodes in the sub-tree of
 *the variable 'subTree' which is of SgNode VariantT 'targetVariant'.
 *******************************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
querySubTree(SgNode *subTree, VariantT targetVariant,
             AstQueryNamespace::QueryDepth defineQueryType =
...
// Liao, 8/27/2009, a more generic nodeList query, not just for nodes of type
// SgNode*
template <typename T>
Rose_STL_Container<T *> queryNodeList(Rose_STL_Container<T *> queryList,
                                      const VariantVector &targetVector) {
...
// Single VariantT
template <typename T>
ROSE_DLL_API inline Rose_STL_Container<T *>
 ...
 *      AstQueryNamespace::QueryDepth defineQueryType =
 *AstQueryNamespace::AllNodes); reutnrs a list of all SgNodes us the AST
 *sub-tree of the variable 'subTree' conforming to the variants in
 *VariantVector.
 *********************************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
querySubTree(SgNode *subTree, const VariantVector &targetVariantVector,
             AstQueryNamespace::QueryDepth defineQueryType =
                 AstQueryNamespace::AllNodes);

// DQ (3/25/2004): Added to support more general form of query based on variant
// value
ROSE_DLL_API NodeQuerySynthesizedAttributeType
queryNodeList(NodeQuerySynthesizedAttributeType, const VariantVector &);

void mergeList(Rose_STL_Container<SgNode *> &nodeList,
               const Rose_STL_Container<SgNode *> &localList);

/********************************************************************************
 * The function
 *  NodeQuerySynthesizedAttributeType
 * queryMemoryPool(SgNode* node, NodeFunctional nodeFunc , VariantVector*
 *targetVariantVector = NULL) will query the memory pool for IR nodes which
 *satisfies the criteria specified in and returned by the predicate in the
 *second argument in the nodes with a corresponding variant in VariantVector.
 ********************************************************************************/
template <typename NodeFunctional>
...
ROSE_DLL_API
NodeQuerySynthesizedAttributeType
queryMemoryPool(SgNode *traversal,
                roseFunctionPointerTwoParameters querySolverFunction,
...
ROSE_DLL_API
NodeQuerySynthesizedAttributeType
queryMemoryPool(TypeOfQueryTypeOneParameter elementReturnType,
                VariantVector *targetVariantVector = NULL);
 ...
 * will return every node in the AST with a corresponding variant in the
 *VariantVector.
 ********************************************************************************/
ROSE_DLL_API NodeQuerySynthesizedAttributeType
queryMemoryPool(VariantVector &targetVariantVector);
