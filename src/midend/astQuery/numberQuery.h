...
typedef NumberQuerySynthesizedAttributeType (*roseFunctionPointerOneParameter)(
    SgNode *);
typedef NumberQuerySynthesizedAttributeType (*roseFunctionPointerTwoParameters)(
    SgNode *, std::string);
 ...
 *AstQueryNamespace::AllNodes); returns a list of all numbers in the sub-tree of
 ...
 *******************************************************************************************/
ROSE_DLL_API NumberQuerySynthesizedAttributeType
querySubTree(SgNode *subTree, std::string traversal,
             roseFunctionPointerTwoParameters querySolverFunction,
             AstQueryNamespace::QueryDepth defineQueryType =
                 AstQueryNamespace::AllNodes);

ROSE_DLL_API NumberQuerySynthesizedAttributeType
queryNodeList(Rose_STL_Container<SgNode *> nodeList, std::string targetNode,
              roseFunctionPointerTwoParameters querySolverFunction);
 ...
 *defineQueryType = AstQueryNamespace::AllNodes); returns a list of all numbers
 ...
 * The function
 *  NumberQuerySynthesizedAttributeType
 * queryMemoryPool(NodeFunctional nodeFunc , VariantVector* targetVariantVector
 *= NULL) will query the memory pool for IR nodes which satisfies the criteria
 *specified in and returned by the predicate in the second argument in the nodes
 *with a corresponding variant in VariantVector.
 ********************************************************************************/
 ...
 ********************************************************************************/
ROSE_DLL_API NumberQuerySynthesizedAttributeType queryMemoryPool(
    std::string traversal, roseFunctionPointerTwoParameters querySolverFunction,
 ...
 ********************************************************************************/
ROSE_DLL_API NumberQuerySynthesizedAttributeType queryMemoryPool(
    std::string traversal, roseFunctionPointerOneParameter querySolverFunction,
    VariantVector *targetVariantVector = NULL);
...
ROSE_DLL_API NumberQuerySynthesizedAttributeType queryMemoryPool(
    std::string traversal, TypeOfQueryTypeTwoParameters elementReturnType,
    VariantVector *targetVariantVector = NULL);
