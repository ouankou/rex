 ...
 * associated with the NumberQuery library.
 *
...
public:
  ...
  //! The useful constructor
  // NumberQueryInheritedAttributeType ( const NumberQueryInheritedAttributeType
  // & X );
  //! Assignment operator
  // NumberQueryInheritedAttributeType & operator= ( const
  // NumberQueryInheritedAttributeType & X );
  //! @}
};
