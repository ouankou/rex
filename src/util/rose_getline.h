 ...
 * storing the buffer address in @p lineptr.  This documentation is copied from
 ...
 * a buffer @p n bytes long, allocated with malloc().  If this buffer is long
 ...
 * the new buffer address back in @p lineptr and the increased size back in @p
 * n.
 *
