 ...
 *
 *  This function is the same as the system strtoull() except it also allows `base` to be two, in which case it parses a
 *  binary literal consisting of '0' and '1' bits.  If `base` is zero and the first non-whitespace characters of the string
