...
public:
  ...
  virtual bool operator()(const T &t) const { return t == sel; }
};
...
public:
  ...
  virtual bool operator()(const T &t) const { return t == sel1 || t == sel2; }
};

template <class T1, class T2> class Select2Object {
public:
...
template <class T1, class T2> class Collect2Object {
public:
