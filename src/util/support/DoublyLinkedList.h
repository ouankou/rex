...
template <class T> class DoublyLinkedEntryWrap {
  T *o;
...
public:
  ...
  DoublyLinkedListWrap() : count(0) { head.prev = head.next = &head; }
  ...
  DoublyLinkedEntryWrap<T> *InsertBefore(const T &o,
                                         DoublyLinkedEntryWrap<T> *pos) {
    DoublyLinkedEntryWrap<T> *e = new DoublyLinkedEntryWrap<T>(o);
    LinkBefore(e, pos);
    return e;
  }
  DoublyLinkedEntryWrap<T> *InsertAfter(const T &o,
                                        DoublyLinkedEntryWrap<T> *pos) {
    DoublyLinkedEntryWrap<T> *e = new DoublyLinkedEntryWrap<T>(o);
    LinkAfter(e, pos);
    return e;
...
template <class T> class CollectDoublyLinkedList : public CollectObject<T> {
