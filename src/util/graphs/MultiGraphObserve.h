...
public:
  ...
  void UpdateObserver(MultiGraphObserver &o) const { o.UpdateDeleteNode(n); }
};
...
public:
  ...
  void UpdateObserver(MultiGraphObserver &o) const { o.UpdateDeleteEdge(n); }
};

template <class NodeInfo>
class MultiGraphObserveNodeTemplate : public MultiGraphElemTemplate<NodeInfo>,
...
class MultiGraphObserveEdgeTemplate : public MultiGraphElemTemplate<EdgeInfo>,
                                      public ObserveObject<MultiGraphObserver> {
protected:
