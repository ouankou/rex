...
public:
  ...
  typename Graph::NodeIterator GetNodeIterator() const {
    return impl->GetNodeIterator();
  }
  bool ContainEdge(const typename Graph::Edge *e) const {
    return impl->ContainEdge(e);
  }
  bool ContainNode(const typename Graph::Node *n) const {
...
public:
  ...
  public:
    ...
    void Advance() {
      BaseClass::impl.Advance();
      SetIterator();
    }
    void Reset() {
      BaseClass::impl.Reset();
      SetIterator();
    }
