...
public:
  ...
  void operator()(const GraphAccessInterface *dg,
                  GraphAccessInterface::Node *node, SCCAnalOperator &op);
  void operator()(const GraphAccessInterface *dg,
                  GraphAccessInterface::NodeIterator iter, SCCAnalOperator &op);
};
...
public:
  SCCGraphCreate(const GraphAccessInterface *orig,
                 SCCGroupGraphOperator *op = 0);
