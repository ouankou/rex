...
private:
  /// Permit the runtime (CLI) to control the verbosity of any logger. It
  /// override the compile-time value (provided by constructor).
  ...
  std::string function;
  /// The human readable identifier of the function. Used for display and to set
...
public:
  Logger();
  Logger(const char *function_, const char *mnemonic_, void *const ptr_id_,
         Level const level_);
