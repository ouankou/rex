...
the AstProcessing chapter will detail how to build alternative
...
\section{Adding Command Line Processing}
   ...
   ROSE passes all non-ROSE and non-legacy frontend specific command line options to the backend
...
specific to ROSE as well as some limited command line processing specific to legacy frontend
(legacy frontend specific command line options will be expanded at some point).
