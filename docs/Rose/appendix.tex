...
\section {Error Messages}
   ...
   The user will mostly only see error messages from the frontend, which
...
of compatibility with GNU (as well as legacy frontend).
               ...
               AST SgFile Constructor: time (sec) =  18.380805
                    AST Front End Processing (SgFile): time (sec) =  4.846442
                         AST Constrution (included Sage III Translation): time (sec) =  4.840888
                              legacy frontend AST Constrution: time (sec) =  0.807095
                              AST legacy frontend/Sage III Translation: time (sec) =  3.926241
                    AST post-processing: time (sec) =  13.513127
                         ...
                         (fixup storage access of forward template declarations (legacy frontend bug)) time (sec) =  0.542976
