...
\begin{enumerate}
   \item Hudson test each "git" branch before it gets checked into the internal
     ...
     about 7 machines and test different versions of CMake options
...
policy.
   ...
   REX uses CMake and CTest. Builds are performed with
{\tt cmake --build <build-dir>} (or {\tt build-rex.sh}), and tests are run with
{\tt ctest --test-dir <build-dir>}. Additional steps are covered in the
...
of automated tests on two different platforms:
\begin{itemize}
   \item 32-bit Linux (Red Hat system 5)
   \item 64-bit Linux (Red Hat system 4)
\end{itemize}
These systems are used to evaluate and report the status of ROSE.  Crontabs are used
...
\begin{description}
  ...
  \item[\{ROSE arguments\ldots\}] : The arguments to the ROSE translator
	prefixed with -rose:$<$ROSE argument$>$, e.g.
	{\tt -rose:verbose 1}. Note, these may be placed anywhere
...
\begin{description}
  ...
  \item[ARGUMENTS] : The compile-line arguments specified on the command-line
	...
	as {\tt -rose:verbose 1} bound for the QMTest test file.
...
g++ -g -Wall -c main.c
/home/yuan5/RoseQMTest/scripts/qm_file.sh rose.RoseTest /home/yuan5/bin/identityTranslator 
g++ -g -Wall -c registers.c
/home/yuan5/RoseQMTest/scripts/qm_file.sh rose.RoseTest /home/yuan5/bin/identityTranslator
g++ -g -Wall -c reader.c
/home/yuan5/RoseQMTest/scripts/qm_file.sh rose.RoseTest /home/yuan5/bin/identityTranslator 
g++ -g -Wall -c decoder.c
/home/yuan5/RoseQMTest/scripts/qm_file.sh rose.RoseTest /home/yuan5/bin/identityTranslator 
g++ -g -Wall -o CPU.out reader.o registers.o decoder.o main.o
\end{verbatim}
}
