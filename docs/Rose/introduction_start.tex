...
do custom analysis and/or transformations on source code. ROSE is
...
compiler analysis, common transformations, and code generation.
   ...
   ROSE works by reading the source code
and generating an Abstract Syntax Tree (AST).  The AST forms
a graph representing the structure of the source code
and is held in memory to provide the fastest possible means 
...
generated ({\em unparsed}) from the AST.
...
most work uniformly on source code.
