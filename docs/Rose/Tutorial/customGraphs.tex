...
More interfaces of \textit{SgGraph} and its subclasses can be found in the ROSE API reference.
...
For more information about them, please refer to the ROSE API reference.
