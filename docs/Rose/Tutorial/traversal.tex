...
within the C++ template metaprogramming community. Since the technique works we present it
...
template metaprogramming community and it happens to work (at one point it didn't work and
...
often within the C++ template metaprogramming community). The input code shown in 
