...
Also, invidual policies for errors types can be configured.  See the RTED API reference
...
The API reference has more information on the organization of the
...
It is wise to enforce all warnings to be handled as errors. This will ensure a clean implementation. We enforced this in our build setup.
