...
# Regenerate build files if required by the MySQL++ instructions for your version.
...
For example (ensure MySQL++ is discoverable by CMake):

\begin{verbatim}
cmake -S <SrcTree> -B <BuildTree> \
  -DCMAKE_PREFIX_PATH=<CompileTree>/src/3rdPartyLibraries/MySQL_Install
\end{verbatim}
