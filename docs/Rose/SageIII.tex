...
option: {\tt  {\tt  {\tt -edg\_parameter:xxx n}, or 
...
\begin{enumerate}
   ...
   \begin{enumerate}
      ...
      \item C++ (strict\_warnings) mode {\tt  \\
        This is the mode used when compiling with the {\tt  violations are issued
   ...
   \begin{enumerate}
      \item ANSI C (non-strict) mode. \\
        ...
        the C89 ANSI standard. Also equivalent to {\tt  option.
      \item ANSI C (strict\_warnings) mode {\tt  \\
        This is the mode used when compiling with the {\tt  in addition to the 
        {\tt  or {\tt -rose:C\_only} options (file must have ".c"
        filename extension).  This implies conformance with the C89 standard,
        violations are issued as warnings.
      \item ANSI C (strict) mode {\tt  \\
        This is the mode used when compiling with the {\tt  in addition to the 
        {\tt  or {\tt -rose:C\_only} options (file must have ".c"
        filename extension).  This implies conformance with the C89 standard,
   ...
   \begin{enumerate}
      \item ANSI C99 default mode. \\
        This is the mode used when compiling with the {\tt  (file must have ".c"
      ...
      \item ANSI C99 {\em strict} mode. \\
        This is the mode used when compiling with the {\tt  in addition to the 
        {\tt  or {\tt -rose:C99\_only} options (file must have ".c"
        filename extension).  This implies conformance with the C89 standard,
        violations are issued as errors.
   \end{enumerate}
   ...
   \item UPC mode. \\
        ...
        {\tt   Note that we have modified the EDG front-end to support
   ...
   \item K\&R C {\em strict} mode. \\
        ...
        {\tt --old\_c} mode (translated from the ROSE {\tt 
\end{enumerate}
