...
# to standard output. The private configuration file is typically "rose_config.h", generated by CMake from
# rose_config.h.in.cmake, and should not be included in end-user header files (e.g., "rose.h") because it pollutes the
# name space. The output is simply a copy of the input, prepending "ROSE_" to each desired CPP symbol.
#
...
#
# In order to make the output look nice, we use the fact that the generated header emits "paragraphs" separated from one
# another by a blank line. The first paragraph contains comments about the file provenance; each remaining paragraph is a
...
#   might generate:
#
#     /* rose_config.h.  Generated from rose_config.h.in.cmake by CMake.  */
