// This test code demonstrates the required specialization of "template <> int
// X<int>::foo()" This test is very similar to test2005_136.C except that the
// template member function is defined outside of the class.
...
template <typename T> int X<T>::foo() {
