...
// phlin 06/20/2012, modify AVX header files
...
static __inline int __attribute__((__gnu_inline__, __always_inline__, __artificial__))
...
#ifdef __x86_64__
static __inline long long  __attribute__((__gnu_inline__, __always_inline__, __artificial__))
...
{
  /* NOTE: legacy frontend wants to see this expressed as a single value.
...
{
  /* NOTE: legacy frontend wants to see this expressed as a single value.
    return __extension__ (__m256i)(__v8si){ __H, __G, __F, __E, __D, __C, __B,
    __A }; */
...
{
  /* NOTE: legacy frontend wants to see this expressed as a single value.
     return __extension__ (__m256i)(__v16hi){ __q00, __q01, __q02, __q03, __q04,
     __q05, __q06, __q07, __q08, __q09, __q10, __q11, __q12, __q13, __q14, __q15
     }; */
...
{
  /* NOTE: legacy frontend wants to see this expressed as a single value.
     return __extension__ (__m256i)(__v32qi){ __q00, __q01, __q02, __q03, __q04,
     __q05, __q06, __q07, __q08, __q09, __q10, __q11, __q12, __q13, __q14,
     __q15,
                                              __q16, __q17, __q18, __q19, __q20,
     __q21, __q22, __q23, __q24, __q25, __q26, __q27, __q28, __q29, __q30, __q31
     }; */
...
{
  /* NOTE: legacy frontend wants to see this expressed as a single value.
    return __extension__ (__m256i)(__v8si){ __A, __A, __A, __A,  __A, __A, __A,
    __A }; */
