...
_mm_set_epi16(short __q7, short __q6, short __q5, short __q4, short __q3,
  ...
  // DQ (8/22/2011): Modified to fix non-gnu extensions.
  // return __extension__ (__m128i)(__v8hi){ __q0, __q1, __q2, __q3, __q4, __q5,
  // __q6, __q7 };
...
_mm_set_epi8(char __q15, char __q14, char __q13, char __q12, char __q11,
             ...
             char __q00) {
  // DQ (8/22/2011): Modified to fix non-gnu extensions.
  // return __extension__ (__m128i)(__v16qi){ __q00, __q01, __q02, __q03, __q04,
...
static __inline void __attribute__((__always_inline__)) _mm_lfence(void) {
  __builtin_ia32_lfence();
}

static __inline void __attribute__((__always_inline__)) _mm_mfence(void) {
